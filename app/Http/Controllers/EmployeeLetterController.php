...
class EmployeeLetterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tracki.employee.letter.list');
    }

    public function create()
    {
        //
        return view('tracki.employee.letter.create');
    }
    ...
    public function list()
    {
        ...
        $op = $op->paginate(request("limit"))->through(function ($op) use ($user) {
            ...
            $profile_action =
                '<a href="' . route("tracki.employee.letter.show", encrypt($op->id)) . '" target="_blank" class="btn-table btn-sm" title="View Template">' .
                '<i class="fa-solid far fa-lightbulb text-warning"></i></a>';
            $update_action =
                '<a href="' . route("tracki.employee.letter.edit", encrypt($op->id)) . '" target="_blank" class="btn btn-sm" title="Edit template">' .
