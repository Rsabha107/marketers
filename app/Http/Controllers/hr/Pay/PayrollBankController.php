...
class PayrollBankController extends Controller
{
    ...
    public function getEntries($id)
    {
        ...
        $view = view('/hr/manager/timesheet/entries/mv/get', [
    ...
    public function payment_list()
    {
        ...
        $employees = $employees->paginate(request("limit"))->through(function ($employee) use ($user) {
            ...
            return [
                ...
                'line_manager' => '<div class="align-middle white-space-wrap fw-bold fs-9">' . $employee->managers?->full_name . '</div>',
                'fee_package' => '<div class="align-middle white-space-wrap fw-bold fs-9">' . number_format($employee->net_salary) . '</div>',
