...
class EmployeeEmergencyContactController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hr.admin..emergency.list', compact('employee_emergencies', 'employees', 'relationships'));
    }
    ...
    public function list($id = null)
    {
        ...
        $op = $op->paginate(request("limit"))->through(function ($op) {
            ...
            return [
                ...
                'first_name' => '<div class="ms-1">' . $op->first_name . ' ' . $op->last_name . '</div>',
                'relationship_id' => '<div class="ms-1">' . $op->relationships->title . '</div>',
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            // Log::info($validator->errors());
            $error = true;
            $message = 'Emergency Contact was not updated.';
        } else {
            $error = false;
    ...
    public function getEditView($id)
    {
        ...
        $view = view('/hr/admin/emergency/mv/edit', [
