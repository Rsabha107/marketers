...
class EmployeeAddressController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hr.admin.address.list', compact(
            'emps',
            'countries',
            'nationalities',
            'employee_types',
    ...
    public function list()
    {
        ...
        $op = EmployeeAddress::orderBy($sort, $order);
    ...
    public function update(Request $request)
    {
        ...
        $count = EmployeeAddress::where('employee_id', $op->employee_id)->count();

        if ($count <= 1) {
            // log::info('less or equal to 1');
            $rules = [
                'employee_address1' => 'required',
                'employee_address_country' => 'required',
                // 'primary_address' => 'required|unique:employee_addresses,primary_address,' . $op->id,
            ];
        } else {
            // log::info('greator than 1');
            $rules = [
                'employee_address1' => 'required',
                'employee_address_country' => 'required',
