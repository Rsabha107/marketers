...
use App\Models\GeneralSettings\GlobalAttachment as GlobalAttachment;
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($request->file('file_name')) {
                ...
                Storage::disk('maketers')->putFileAs($request->model_name, $file, $filename);
                // $file->store('private');
                // Storage::putFileAs();
                ...
                $data->file_path = '/app/attachments/'.$request->model_name.'/';
                $data->user_id = $id;
