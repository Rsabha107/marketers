function refreshEmpEdit(val) {
    ...
    $.ajax({
        url: "/hr/admin/employee/mv/edit" + val,
        method: "GET",
        async: false,
...
$(document).ready(function () {
    ...
    $("body").on("click", "#edit_employee", function () {
        ...
        $.ajax({
            url: "/hr/admin/employee/mv/edit/" + id,
            method: "GET",
            async: true,
            success: function (response) {
                g_response = response.view;
    ...
    $("body").on("click", "#duplicate_employee", function () {
        ...
        $.ajax({
            url: "/hr/admin/employee/mv/duplicate/" + id,
            method: "GET",
            async: true,
            success: function (response) {
                g_response = response.view;
    ...
    $("body").on("click", "#deleteEmployee", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/hr/admin/employee/delete/" + id,
                    method: "GET",
    ...
    $("body").on("click", "#restoreEmployee", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/hr/admin/employee/restore/" + id,
                    method: "GET",
                    success: function (result) {
                        if (!result["error"]) {
                            toastr.success(result["message"]);
