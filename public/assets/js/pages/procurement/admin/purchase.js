...
$(document).ready(function () {
    ...
    $("body").on("click", "#offcanvas-add-purchase", function () {
        console.log("inside #offcanvas-add-purchase");
        // $("#add_edit_form").get(0).reset()
        // console.log(window.choices.removeActiveItems())
        $("#cover-spin").show();
        $("#offcanvas-add-purchase-modal").offcanvas("show");
        $("#cover-spin").hide();
    ...
    $("body").on("click", "#delete_purchase", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/procurement/admin/purchase/delete/" + id,
                    type: "DELETE",
                    headers: {
