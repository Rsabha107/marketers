...
use App\Http\Controllers\Procurement\Admin\ItemMasterController as AdminItemMasterController;
use App\Http\Controllers\Procurement\Admin\PurchaseOrderController as AdminPurchaseOrderController;
use App\Http\Controllers\Procurement\Admin\VendorController  as AdminVendorController;
...
use App\Http\Controllers\ProjectMgt\Admin\TaskTemplateController as AdminTaskTemplateController;
...
Route::group(['middleware' => 'prevent-back-history', 'XssSanitizer'], function () {
    ...
    Route::middleware(['auth', 'otp', 'XssSanitizer', 'role:SuperAdmin|Procurement', 'roles:admin', 'prevent-back-history', 'auth.session'])->group(function () {
        ...
        Route::controller(CompanyController::class)->group(function () {
            Route::get('/general/settings/company/', 'index')->name('general.settings.company')->middleware('permission:purchase.show');
        ...
        Route::controller(CompanyAddressController::class)->group(function () {
            Route::get('/general/settings/address/', 'index')->name('general.settings.address')->middleware('permission:employee.show');
            Route::get('/general/settings/address/list/{id?}', 'list')->name('general.settings.address.list')->middleware('permission:employee.show');
            ...
            Route::get('/general/settings/address/add', 'add')->name('general.settings.address.add')->middleware('permission:employee.create');
        ...
        Route::controller(CurrencyController::class)->group(function () {
            Route::get('/general/settings/currency/', 'index')->name('general.settings.currency')->middleware('permission:employee.show');
            Route::get('/general/settings/currency/list/{id?}', 'list')->name('general.settings.currency.list')->middleware('permission:employee.show');
            ...
            Route::get('/general/settings/currency/add', 'add')->name('general.settings.currency.add')->middleware('permission:employee.create');
    ...
    // PROCUREMENT MANAGEMENT ******************************************************************** Admin All Route
    Route::middleware(['auth', 'otp', 'XssSanitizer', 'role:SuperAdmin|Procurement', 'roles:admin', 'prevent-back-history', 'auth.session'])->group(function () {

        // Vendors Routes
        Route::controller(AdminVendorController::class)->group(function () {

            Route::get('/procurement/admin/vendor/', 'index')->name('procurement.admin.vendor')->middleware('permission:purchase.show');
            Route::get('/procurement/admin/vendor/list/{id?}', 'list')->name('procurement.admin.vendor.list')->middleware('permission:purchase.show');
            Route::post('/procurement/vendor/store', 'store')->name('procurement.vendor.store');
            Route::post('/procurement/vendor/update', 'update')->name('procurement.vendor.update');
            Route::get('/procurement/admin/vendor/mv/get/{id}', 'get')->name('procurement.admin.vendor.mv.get');
            Route::delete('/procurement/admin/vendor/delete/{id}', 'destroy')->name('procurement.admin.vendor.delete');
        });

        Route::controller(AdminPurchaseOrderController::class)->group(function () {
            Route::get('/procurement/admin/purchase/', 'index')->name('procurement.admin.purchase')->middleware('permission:purchase.show');
        ...
        Route::controller(AdminItemMasterController::class)->group(function () {
            Route::get('/procurement/admin/items/', 'index')->name('procurement.admin.items')->middleware('permission:purchase.show');
            Route::get('/procurement/admin/items/list/{id?}', 'list')->name('procurement.admin.items.list')->middleware('permission:purchase.show');
            Route::post('/procurement/items/store', 'store')->name('procurement.items.store');
            Route::post('/procurement/items/update', 'update')->name('procurement.items.update');
            Route::get('/procurement/admin/items/mv/edit/{id}', 'get')->name('procurement.admin.items.mv.get');
            Route::delete('/procurement/admin/items/delete/{id}', 'destroy')->name('procurement.admin.items.delete');
            // Route::get('/procurement/admin/item/get/{id}', 'getItem')->name('procurement.admin.item.get');
        });
    });
    ...
    Route::middleware(['auth', 'otp', 'XssSanitizer', 'role:SuperAdmin|PROJECTMGT', 'roles:admin', 'prevent-back-history', 'auth.session'])->group(function () {
        ...
        Route::controller(AdminProjectController::class)->group(function () {
            ...
            Route::get('/', 'index')->name('projects.index')->middleware('permission:project.show');
            ...
            Route::get('/projects/admin/project/mv/get/{id}', 'getProjectView')->name('projects.admin.project.get.mv');
            ...
            Route::post('/projects/admin/board/update', 'kanbanUpdate')->name('projects.admin.board.update')->middleware('permission:task.show');

            //update project client
            Route::post('/projects/admin/project/update/client', 'updateClient')->name('projects.admin.project.update.client')->middleware('permission:task.show');
        ...
        Route::controller(AdminTaskController::class)->group(function () {
            ...
            Route::get('/projects/admin/task/getprojectassigned/{id}', 'getProjectAssigned')->name('projects.admin.task.getprojectassigned')->middleware('permission:task.show');
        ...
        //Task Template route
        Route::controller(AdminTaskTemplateController::class)->group(function () {
            Route::get('/projects/admin/task/template', 'index')->name('projects.admin.task.template.index');
            Route::get('/projects/admin/task/template/list', 'list')->name('projects.admin.task.template.list');
            Route::post('/projects/admin/task/template/update', 'update')->name('projects.admin.task.template.update');
            Route::post('/projects/admin/task/template/store', 'store')->name('projects.admin.task.template.store');
            Route::get('/projects/admin/task/template/edit/{id}', 'edit')->name('projects.admin.task.template.edit');
            Route::delete('/projects/admin/task/template/delete/{id}', 'destroy')->name('projects.admin.task.template.delete');
        });
    ...
    //     // Venue
    //     Route::get('/tracki/setup/venue', [AdminVenueController::class, 'index'])->name('tracki.setup.venue');
    //     Route::get('/tracki/setup/venue/list', [AdminVenueController::class, 'list'])->name('tracki.setup.venue.list');
    //     Route::get('/tracki/setup/venue/{id}/get', [AdminVenueController::class, 'get'])->name('tracki.setup.venue.get');
    //     Route::post('tracki/setup/venue/update', [AdminVenueController::class, 'update'])->name('tracki.setup.venue.update');
    //     Route::delete('/tracki/setup/venue/{id}/delete', [AdminVenueController::class, 'delete'])->name('tracki.setup.venue.delete');
    //     Route::post('/tracki/setup/venue/store', [AdminVenueController::class, 'store'])->name('tracki.setup.venue.store');
    ...
    Route::middleware(['prevent-back-history'])->group(function () {
        ...
        Route::get('/auth/signin', [AdminController::class, 'signIn'])->name('auth.signin')->middleware('prevent-back-history');
