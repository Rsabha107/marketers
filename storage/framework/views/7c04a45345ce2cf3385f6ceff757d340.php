        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table  id="currency_table"
                        ...
                        data-url="<?php echo e(route('general.settings.currency.list')); ?>"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-field="symbol"><?= get_label('symbol', 'Symbol') ?></th>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/components/generalsettings/currency-card.blade.php ENDPATH**/ ?>