...
<div class="content">
    ...
    <div class="row">
        <div class="col-xl-8">
            <form action="<?php echo e(route ('sec.rolesetup.create')); ?>" class="row g-3 mb-9 needs-validation" novalidate="" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="col-sm-6 col-md-9">
                    ...
                    <div class="col-12 d-flex justify-content-start mt-6">
                        ...
                        <a class="btn btn-phoenix-danger me-2 px-6" href="<?php echo e(route('sec.rolesetup.list')); ?>">Cancel</a>
...
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\sec\rolesetup\add.blade.php ENDPATH**/ ?>