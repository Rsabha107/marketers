...
<?php if(Request::is('tracki/employee')): ?>
...
<div class="offcanvas offcanvas-end w-70" data-bs-backdrop="static" id="edit_employee_modal" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body">
        <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_form" novalidate="" action="<?php echo e(route ('tracki.employee.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<div class="offcanvas offcanvas-end w-70" data-bs-backdrop="static" id="duplicate_employee_modal" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body">
        <form class="row g-3  px-3 needs-validation form-submit-event" id="duplicate_employee_form" novalidate="" action="<?php echo e(route ('tracki.employee.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="add_employee_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-top modal-dialog-scrollable">
        <div class="modal-content ">
            ...
            ?>
            <div class="modal-body">
                <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_formxx" novalidate="" action="<?php echo e(route ('tracki.employee.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/employee/timesheet/entries*')): ?>
<div class="modal fade" id="edit_employee_timesheet_entry_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_entry_form" novalidate="" action="<?php echo e(route ('tracki.employee.timesheet.entries.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/employee/timesheet') || Request::is('tracki/employee/profile*')): ?>
<div class="modal fade" id="add_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_form" novalidate="" action="<?php echo e(route ('tracki.employee.timesheet.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="add_employee_profile_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_profile_form" novalidate="" action="<?php echo e(route ('tracki.employee.timesheet.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" id="add_employee_timesheet_table_h" name="table" value="employee_timesheet_table">
...
<div class="modal fade" id="edit_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_form" novalidate="" action="<?php echo e(route ('tracki.employee.timesheet.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/employee/salary') || Request::is('tracki/employee/profile*')): ?>
<div class="modal fade" id="add_employee_salary_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_salary_form" novalidate="" action="<?php echo e(route ('tracki.employee.salary.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_employee_salary_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_salary_form" novalidate="" action="<?php echo e(route ('tracki.employee.salary.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/employee/bank') || Request::is('tracki/employee/profile*')): ?>
<div class="modal fade" id="add_employee_bank_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_bank_form" novalidate="" action="<?php echo e(route ('tracki.employee.bank.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_employee_bank_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_bank_form" novalidate="" action="<?php echo e(route ('tracki.employee.bank.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/employee/emergency') || Request::is('tracki/employee/profile*')): ?>
<div class="modal fade" id="add_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_emergency_form" novalidate="" action="<?php echo e(route ('tracki.employee.emergency.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_emergency_form" novalidate="" action="<?php echo e(route ('tracki.employee.emergency.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="inputEmail4">First Name</label>
                            <input name="first_name" maxlength="50" id="edit_first_name" class="form-control" type="text" placeholder="">
                            <!-- <div class="invalid-feedback">This field is required.</div> -->
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="inputEmail4">Last Name</label>
                            <input name="last_name" maxlength="50" id="edit_last_name" class="form-control" type="text" placeholder="">
                            <!-- <div class="invalid-feedback">This field is required.</div> -->
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="inputEmail4"> Relationship <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input name="contact_number" maxlength="50" id="edit_contact_number" class="form-control" type="text" placeholder="">
                            <!-- <div class="invalid-feedback">This field is required.</div> -->
                        </div>
                        <!-- </div> -->
                    </div>
...
<?php if(Request::is('tracki/employee/address') || Request::is('tracki/employee/profile*')): ?>
<div class="modal fade" id="add_employee_address_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_address_form" novalidate="" action="<?php echo e(route ('tracki.employee.address.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_employee_address_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content bg-body-highlight">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_address_form" novalidate="" action="<?php echo e(route ('tracki.employee.address.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if((Request::is('xxxtracki/project/*') || Request::is('xxxtracki/users/create-new') || Request::is('xxxtracki/task/*/list')) && !Request::is('xxxtracki/project/archive')): ?>
<div class="offcanvas offcanvas-start w-50" id="offcanvasAddEditProject" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body">
        ...
        <form class="row g-3 needs-validation form-submit-event" id="add_edit_project_form" novalidate="" action="<?php echo e(route ('tracki.project.create')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-12">
                ...
                <select name="workspace_id" class="form-select" id="add_edit_project_workspace_id" required style="background-color: #ADC5FF;">
                    <option selected="selected" value="">Select...</option>
                    <?php $__currentLoopData = $workspaces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($item->id); ?>">
                        <?php echo e($item->title); ?>
            ...
            <div class="col-md-3">
                ...
                <select name="audience_id" class="form-select" id="add_edit_project_audience" required>
                    <option selected="selected" value="">Select...</option>
                    <?php $__currentLoopData = $event_audience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(Request::old('id') == $item->id ): ?>
                    <option value="<?php echo e($item->id); ?>" selected>
                        <?php echo e($item->name); ?>
            ...
            <div class="col-md-3">
                ...
                <select name="venue_id" class="form-select" id="add_edit_project_venue" required>
                    <option selected="selected" value="">Select...</option>
                    <?php $__currentLoopData = $event_venue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(Request::old('id') == $item->id ): ?>
                    <option value="<?php echo e($item->id); ?>" selected>
                        <?php echo e($item->name); ?>
            ...
            <div class="col-md-3">
                ...
                <select name="location_id" class="form-select" id="add_edit_project_location" required>
                    <option selected="selected" value="">Select...</option>
                    <?php $__currentLoopData = $event_location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(Request::old('id') == $item->id ): ?>
                    <option value="<?php echo e($item->id); ?>" selected>
                        <?php echo e($item->name); ?>
            ...
            <div class="col-md-3">
                ...
                <select name="fund_category_id" class="form-select" id="add_edit_project_fund" required>
                    <option selected="selected" value="">Select...</option>
                    <?php $__currentLoopData = $fund_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(Request::old('id') == $item->id ): ?>
                    <option value="<?php echo e($item->id); ?>" selected>
                        <?php echo e($item->name); ?>
            ...
            <div class="col-md-3">
                ...
                <select name="budget_name_id" class="form-select" id="add_edit_project_budget" required>
                    <option selected="selected" value="">Select...</option>
                    <?php $__currentLoopData = $budget_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(Request::old('id') == $item->id ): ?>
                    <option value="<?php echo e($item->id); ?>" selected>
                        <?php echo e($item->name); ?>
...
<?php if(Request::is('tracki/setting/address_type*')): ?>
<div class="modal fade" id="create_address_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_address_type_form" novalidate="" action="<?php echo e(route('tracki.setting.address_type.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_address_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_address_type_form" novalidate="" action="<?php echo e(route('tracki.setting.address_type.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/prefix*')): ?>
<div class="modal fade" id="create_prefix_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_prefix_form" novalidate="" action="<?php echo e(route('tracki.setting.prefix.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_prefix_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_prefix_form" novalidate="" action="<?php echo e(route('tracki.setting.prefix.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/gender*')): ?>
<div class="modal fade" id="create_gender_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_gender_form" novalidate="" action="<?php echo e(route('tracki.setting.gender.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_gender_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_gender_form" novalidate="" action="<?php echo e(route('tracki.setting.gender.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/invoice/notes*')): ?>
<div class="modal fade" id="create_invoice_notes_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_invoice_notes_form" novalidate="" action="<?php echo e(route('tracki.setting.invoice.notes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_invoice_notes_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_invoice_notes_form" novalidate="" action="<?php echo e(route('tracki.setting.invoice.notes.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/marital*')): ?>
<div class="modal fade" id="create_marital_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_marital_form" novalidate="" action="<?php echo e(route('tracki.setting.marital.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_marital_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_marital_form" novalidate="" action="<?php echo e(route('tracki.setting.marital.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/entities*')): ?>
<div class="modal fade" id="create_entity_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_entity_form" novalidate="" action="<?php echo e(route('tracki.setting.entities.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_entity_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_entity_form" novalidate="" action="<?php echo e(route('tracki.setting.entities.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/element/classifications*')): ?>
<div class="modal fade" id="create_element_classificaiton_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_element_classification_form" novalidate="" action="<?php echo e(route('tracki.setting.element.classifications.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_element_classificaiton_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_element_classificaiton_form" novalidate="" action="<?php echo e(route('tracki.setting.element.classifications.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/element')): ?>
<div class="modal fade" id="create_element_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_element_form" novalidate="" action="<?php echo e(route('tracki.setting.element.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_element_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_element_form" novalidate="" action="<?php echo e(route('tracki.setting.element.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/element_set')): ?>
<div class="modal fade" id="create_element_set_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="mb-0" id="staticBackdropLabel"><?= get_label('create_element_set', 'Create element_set') ?></h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="needs-validation px-3 form-submit-event" id="create_element_set_form" novalidate="" action="<?php echo e(route('tracki.setting.element_set.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="table" value="element_set_table">
...
<div class="modal fade" id="edit_element_set_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            <div class="modal-header">
                <h3 class="mb-0" id="staticBackdropLabel">Edit element_set</h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="needs-validation form-submit-event" id="edit_element_set_form" novalidate="" action="<?php echo e(route('tracki.setting.element_set.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>

                <input type="hidden" id="edit_element_set_id" name="id" value="">
                <input type="hidden" id="edit_element_set_table" name="table" value="">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="entity_name" class="form-label"><?= get_label('title', 'Title') ?> <span class="asterisk">*</span></label>
                        <input type="text" class="form-control" name="title" id="edit_element_set_title" required placeholder="<?= get_label('please_enter_title', 'Please enter title') ?>" />
                    </div>
...
<?php if(Request::is('tracki/setting/directorates*')): ?>
<div class="modal fade" id="create_directorate_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_directorate_form" novalidate="" action="<?php echo e(route('tracki.setting.directorates.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_directorate_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_directorate_form" novalidate="" action="<?php echo e(route('tracki.setting.directorates.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/relationships*')): ?>
<div class="modal fade" id="create_relationship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_relationship_form" novalidate="" action="<?php echo e(route('tracki.setting.relationships.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_relationship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_relationship_form" novalidate="" action="<?php echo e(route('tracki.setting.relationships.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/leave_types*')): ?>
<div class="modal fade" id="create_leave_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_leave_type_form" novalidate="" action="<?php echo e(route('tracki.setting.leave_types.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_leave_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_leave_type_form" novalidate="" action="<?php echo e(route('tracki.setting.leave_types.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/countries*')): ?>
<div class="modal fade" id="create_country_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_country_form" novalidate="" action="<?php echo e(route('tracki.setting.countries.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_country_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_country_form" novalidate="" action="<?php echo e(route('tracki.setting.countries.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/nationalities*')): ?>
<div class="modal fade" id="create_nationality_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_nationality_form" novalidate="" action="<?php echo e(route('tracki.setting.nationalities.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_nationality_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_nationality_form" novalidate="" action="<?php echo e(route('tracki.setting.nationalities.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/pay_cycle*')): ?>
<div class="modal fade" id="create_pay_cycle_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_pay_cycle_form" novalidate="" action="<?php echo e(route('tracki.setting.pay_cycle.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_pay_cycle_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_pay_cycle_form" novalidate="" action="<?php echo e(route('tracki.setting.pay_cycle.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/job_level*')): ?>
<div class="modal fade" id="create_job_level_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_job_level_form" novalidate="" action="<?php echo e(route('tracki.setting.job_level.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_job_level_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_job_level_form" novalidate="" action="<?php echo e(route('tracki.setting.job_level.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/sponsorship*')): ?>
<div class="modal fade" id="create_sponsorship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_sponsorship_form" novalidate="" action="<?php echo e(route('tracki.setting.sponsorship.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_sponsorship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_sponsorship_form" novalidate="" action="<?php echo e(route('tracki.setting.sponsorship.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/contract_type*')): ?>
<div class="modal fade" id="create_contract_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_contract_type_form" novalidate="" action="<?php echo e(route('tracki.setting.contract_type.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_contract_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_contract_type_form" novalidate="" action="<?php echo e(route('tracki.setting.contract_type.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/designations')): ?>
<!-- designations modal -->
<div class="modal fade" id="create_designations_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event" action="<?php echo e(route('tracki.setting.designations.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_designations_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="edit_form_submit_event" action="<?php echo e(route('tracki.setting.designations.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/departments')): ?>
<!-- departments modal -->
<div class="modal fade" id="create_departments_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event" action="<?php echo e(route('tracki.setting.departments.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_departments_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="edit_form_submit_event" action="<?php echo e(route('tracki.setting.departments.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/funcareas')): ?>
<!-- venues modal -->
<div class="modal fade" id="create_funcareas_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event" action="<?php echo e(route('tracki.setting.funcareas.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_funcareas_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="edit_form_submit_event" action="<?php echo e(route('tracki.setting.funcareas.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\modals.blade.php ENDPATH**/ ?>