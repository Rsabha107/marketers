...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0">
                        ...
                        <?php endif; ?>
                        <p class="approved_by"><?php echo e(__('invoices::invoice.approved_by')); ?> <strong> <?php echo $invoice->approvedBy; ?></strong></p>
            ...
            <thead>
                <tr>
                    <th class="border-0 pl-0 party-header" width="48.5%">
                        <?php echo e(__('invoices::invoice.client')); ?>

                    </th>
                    <th class="border-0" width="3%"></th>
                    <th class="border-0 pl-0 party-header">
                        <?php echo e(__('invoices::invoice.bill_to')); ?>
                    ...
                    <td class="px-0">
                        ...
                        <?php if($invoice->buyer->address): ?>
                            <!-- <p class="buyer-address"> -->
                                <!-- <?php echo e(__('invoices::invoice.address')); ?>:  -->
                                <?php echo e($invoice->buyer->address); ?>

                                <br>
                            <!-- </p> -->
                        <?php endif; ?>

                        <?php if($invoice->buyer->address2): ?>
                            <!-- <p class="buyer-address"> -->
                                <!-- <?php echo e(__('invoices::invoice.address')); ?>:  -->
                                <?php echo e($invoice->buyer->address2); ?>
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="text-right border-0"><?php echo e(__('invoices::invoice.days_worked')); ?></th>
                    <th scope="col" class="text-right border-0"><?php echo e(__('invoices::invoice.leave_days_taken')); ?></th>
                    <th scope="col" class="text-right border-0"><?php echo e(__('invoices::invoice.unpaid_leaves')); ?></th>
                    <th scope="col" class="text-right border-0"><?php echo e(__('invoices::invoice.daily_rate')); ?></th>
                    <th scope="col" class="text-right border-0"><?php echo e(__('invoices::invoice.total_days_eligible')); ?></th>
                    <th scope="col" class="text-right border-0"><?php echo e(__('invoices::invoice.fee')); ?></th>
                    <th scope="col" class="text-right border-0"><?php echo e(__('invoices::invoice.payment')); ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <?php echo e(($item->days_worked)); ?>

                    </td>
                    <td class="text-right">
                        <?php echo e(($item->leave_days_taken)); ?>

                    </td>
                    <td class="text-right">
                        <?php echo e(($item->unpaid_leaves)); ?>

                    </td>
                    <td class="text-right">
                        <?php echo e($invoice->formatCurrency($item->daily_rate)); ?>

                    </td>
                    <td class="text-right">
                        <?php echo e(($item->total_days_eligible)); ?>

                    </td>
                    <td class="text-right">
                        <?php echo e($invoice->formatCurrency($item->salary)); ?>

                    </td>
                    <td class="text-right">
                        <?php echo e($invoice->formatCurrency($item->payment)); ?>
        ...
        <?php if($invoice->notes): ?>
            <p>
                <?php echo e(__('invoices::invoice.notes')); ?>: <?php echo $invoice->notes; ?>

            </p>
        <?php endif; ?>

        <?php if($invoice->notes2): ?>
            <p>
                <?php echo e(__('invoices::invoice.notes')); ?>: <?php echo $invoice->notes2; ?>

            </p>
        <?php endif; ?>

        <!-- <p>
            <?php echo e(__('invoices::invoice.pay_until')); ?>: <?php echo e($invoice->getPayUntilDate()); ?>

        </p> -->

        <script type="text/php">
            if (isset($pdf) && $PAGE_COUNT > 1) {
                $text = "<?php echo e(__('invoices::invoice.page')); ?> {PAGE_NUM} / {PAGE_COUNT}";
                $size = 10;
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/vendor/invoices/templates/timesheet.blade.php ENDPATH**/ ?>