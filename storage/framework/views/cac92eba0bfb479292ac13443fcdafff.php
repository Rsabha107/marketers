                                ...
                                <table class="table table-bordered my-3 rounded" id="example">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">2</td>
                                            <td class="text-center"><?php echo e($totalleavestaken); ?></td>
                                            <td class="text-center"><?php echo e(2-$totalleavestaken); ?></td>
                                        </tr>
...
<!-- </form> -->
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\employee\managers\leave\mv\balance.blade.php ENDPATH**/ ?>