    ...
    <div class="d-flex align-items-end position-relative mb-7">
      ...
      <div class="hoverbox" style="width: 150px; height: 150px">
        ...
        <div class="position-relative bg-body-quaternary rounded-circle cursor-pointer d-flex flex-center mb-xxl-7">
          <div class="avatar avatar-5xl"><img class="rounded-circle" src="<?php echo e(asset ('fnx/assets/img/team/150x150/58.webp')); ?>" alt="" /></div>
...
<script src="<?php echo e(asset('assets/js/pages/element/element_sets.js')); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\admin\setting\elementset\assignment.blade.php ENDPATH**/ ?>