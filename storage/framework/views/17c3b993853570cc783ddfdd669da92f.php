    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="employee_address_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                ...
                data-url="<?php echo e(route('hr.admin.address.list')); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/components/admin-employee-addresses-card.blade.php ENDPATH**/ ?>