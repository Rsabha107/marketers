...
<div class="content">
    ...
    <!-- <?php echo $__env->make('main.partials.flash-message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> -->
        ...
        <form class="row g-3 needs-validation" novalidate="" method="POST" action="<?php echo e(route('main.order.store')); ?>" id="createOrderForm">
            <?php echo csrf_field(); ?>
            <div class="card mb-5">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <select name="site_type" class="form-select" id="floatingSiteType" required>
                                                ...
                                                <?php $__currentLoopData = $venue_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue_types): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(Request::old('site_type') == $venue_types->id ): ?>
                                                <option value="<?php echo e($venue_types->id); ?>" selected>
                                                    <?php echo e($venue_types->name); ?>

                                                </option>
                                                <?php else: ?>
                                                <option value="<?php echo e($venue_types->id); ?>">
                                                    <?php echo e($venue_types->name); ?>
                                                            ...
                                                            <div class="col-12 col-sm-6 col-xl-12">
                                                                <div class="mb-4">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        <?php $__currentLoopData = $logical_space_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logical_space_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if(Request::old('logical_space_category') === $logical_space_category->categories_id ): ?>
                                                                        <option
                                                                            value="<?php echo e($logical_space_category->categories_id); ?>"
                                                                            selected>
                                                                            <?php echo e($logical_space_category->categories_name); ?>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <select class="form-select item_category" data-width="100%"
                                                ...
                                                <?php $__currentLoopData = $item_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(Request::old('item_category') == $item_cat->item_category_id ): ?>
                                                <option value="<?php echo e($item_cat->item_category_id); ?>" selected>
                                                    <?php echo e($item_cat->item_category_name); ?>

                                                </option>
                                                <?php else: ?>
                                                <option value="<?php echo e($item_cat->item_category_id); ?>">
                                                    <?php echo e($item_cat->item_category_name); ?>
    ...
    <script src="<?php echo e(asset ('assets/js/order-form-custom.js')); ?>"></script>

    <?php echo $__env->make('main.partials.order-form-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php $__env->stopPush(); ?>

<?php echo $__env->make('main.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\order-form.blade.php ENDPATH**/ ?>