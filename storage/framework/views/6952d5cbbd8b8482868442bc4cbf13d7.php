<div class="modal fade" id="add_business_address_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_business_address_form" novalidate="" action="<?php echo e(route ('general.settings.address.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_business_address_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content bg-body-highlight">
            ...
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_business_address_form" novalidate="" action="<?php echo e(route ('general.settings.address.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<!-- </div> --><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\general\settings\partials\gs_address_modal.blade.php ENDPATH**/ ?>