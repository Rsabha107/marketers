        ...
        <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
          ...
          <div class="px-xxl-5">
            <div class="text-center mb-6">
              ...
              <?php endif; ?>
              <form class="verification-form" data-2fa-form="tracki-2fa-form" method="POST" action="<?php echo e(route('auth.otp.post')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <a class="fs-9" href="<?php echo e(route('otp.resend.get')); ?>">Didn’t receive the code? </a>
                <br>
                <a class="fs-9" href="<?php echo e(route('tracki.auth.signin')); ?>">Back to login page </a>
              </form>
            </div>
          </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\auth\otp.blade.php ENDPATH**/ ?>