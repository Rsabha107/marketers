                                ...
                                <div class="card-body">
                                    <div class="row align-items-center g-3 text-center text-xl-start">
                                        ...
                                        <div class="col-12 col-sm-auto flex-1">
                                            <h3 class="fw-bolder mb-2"><?php echo e($user->name); ?></h3>


                                            <p class="mb-0"><?php echo e($user->email); ?></p><a class="fw-bold" href="#!"><?php echo e($user->phone); ?></a>
                                            ...
                                            <div class="d-flex flex-between-center border-top border-dashed pt-4">
                                                <div>
                                                    <h6>Projects</h6>
                                                    <p class="fs-7 text-body-secondary mb-0"><?php echo e($project_count->count()); ?></p>
                                                </div>
                                                <div>
                                                    <h6>Tasks</h6>
                                                    <p class="fs-7 text-body-secondary mb-0"><?php echo e($tasks->count()); ?></p>
                                                </div>
                                                <div>
                                                    <h6>Todos</h6>
                                                    <p class="fs-7 text-body-secondary mb-0"><?php echo e($user->todos->count()); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card todo-list h-100">
                                        ...
                                        <div class="card-body py-0 scrollbar to-do-list-body">
                                            ...
                                            <div class="d-flex hover-actions-trigger py-3 border-translucent border-top">
                                                ...
                                                <!-- <input class="form-check-input flex-shrink-0 form-check-line-through mt-0 me-2 form-check-input-undefined" type="checkbox" onclick="update_todo_status(this)" name="subtask-<?php echo e($todo->id); ?>" id="<?php echo e($todo->id); ?>" <?php echo e($is_completed_flag); ?>> -->
                                                <input class="form-check-input form-check-input-todolist flex-shrink-0 my-1 me-2 form-check-input-undefined" type="checkbox" onclick="update_todo_status(this)" name="subtask-<?php echo e($todo->id); ?>" id="<?php echo e($todo->id); ?>" <?php echo e($is_completed_flag); ?> data-event-propagation-prevent="data-event-propagation-prevent" />
                                                <div class="row justify-content-between align-items-md-center btn-reveal-trigger border-translucent gx-0 flex-1 cursor-pointer" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                    <div class="col-12 col-md-auto col-xl-12 col-xxl-auto">
                                                        <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
                                                            <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-8 me-2 line-clamp-1 text-body cursor-pointer"><?php echo e($todo->title); ?></label><span class="badge badge-phoenix ms-auto fs-10 badge-phoenix-<?php echo e($todo->priority->color); ?>"><?php echo e($todo->priority->title); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-auto col-xl-12 col-xxl-auto">
                                                        <div class="d-flex lh-1 align-items-center"><a class="text-body-tertiary fw-bold fs-10 me-2" href="#!"><span class="fas fa-paperclip me-1"></span>2</a>
                                                            <p class="text-body-tertiary fs-10 mb-md-0 me-2 me-md-3 me-xl-2 me-xxl-3 mb-0"><?php echo e(format_date($todo->created_at, null,  'd M, Y')); ?></p>
                                                            <div class="hover-md-hide hover-xl-show hover-xxl-hide">
                                                                <p class="text-body-tertiary fs-10 fw-bold mb-md-0 mb-0 ps-md-3 ps-xl-0 ps-xxl-3 border-start-md border-xl-0 border-start-xxl"><?php echo e(format_date($todo->created_at, null,  'h:i A')); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('tracki.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\users\details.blade.php ENDPATH**/ ?>