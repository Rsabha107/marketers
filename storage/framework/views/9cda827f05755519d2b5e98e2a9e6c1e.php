                        ...
                        <div class="card-body pe-md-0">
                            <div class="row align-items-center gx-0 gy-7">
                                <div
                                    ...
                                    <div class="bg-holder"
                                        style="background-image:url(<?php echo e(asset('assets/img/bg/38.png')); ?>);">
                                    </div>
                                    <!--/.bg-holder-->
                                ...
                                <div class="col mx-auto">
                                    <div class="auth-form-box">
                                        <div class="text-center mb-5"><a
                                                ...
                                                href="<?php echo e(route('main.dashboard')); ?>">
                                        ...
                                        <?php endif; ?>
                                        <form method="POST" action="<?php echo e(route('admin.signup.create')); ?>"
                                            ...
                                            <div class="mb-3 text-start">
                                                ...
                                                <input class="form-control" name="username" id="user_name" type="text"
                                                    placeholder="User Name" value="<?php echo e(old('user_name')); ?>" required>
                                            </div>
                                            <div class="mb-3 text-start">
                                            ...
                                            <div class="mb-3 text-start" id="FASelect">
                                                ...
                                                <select name="functional_area_id" class="form-select"
                                                    ...
                                                    <?php $__currentLoopData = $fa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <!-- <div class="text-center"><a class="fs-9 fw-bold" href="<?php echo e(route('main.auth.login')); ?>">Sign in to an existing account</a></div> -->
                                            <div class="text-center"><a class="fs-9 fw-bold"
                                                    href="<?php echo e(route('main.dashboard')); ?>">Go back to dashboard</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\auth\sign-up.blade.php ENDPATH**/ ?>