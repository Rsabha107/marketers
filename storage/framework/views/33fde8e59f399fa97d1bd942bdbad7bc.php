...
<!-- ===============================================-->
        ...
        <div class="mb-4 mt-4">
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="ms-xxl-auto">
                    ...
                    <a href="<?php echo e(route('tracki.employee.letter.create')); ?>" target="_blank">
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\employee\letter\list.blade.php ENDPATH**/ ?>