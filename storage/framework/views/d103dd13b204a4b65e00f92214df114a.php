...
<!-- ===============================================-->
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('hr.admin.letter.generate')); ?>">
        ...
        <div class="row g-4">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="card border border-primary mb-3">
                    <div class="card-body">
                        <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_letter_form" novalidate="" action="<?php echo e(route ('hr.admin.letter.generate.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-6">
                                <select class="form-select" id="letter_type" name="letter_type" aria-label="Default select example" required>
                                    ...
                                    <?php $__currentLoopData = $letters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-6">
                                <select class="form-select" id="template_employee_id" name="employee_id" aria-label="Default select example" required>
                                    ...
                                    <option value="<?php echo e($key->id); ?>"><?php echo e($key->full_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-12">
    ...
    <!-- <script src="<?php echo e(asset('assets/js/pages/employees_letter_generate.js')); ?>"></script> -->

    <?php $__env->stopSection(); ?>

    <?php $__env->startPush('script'); ?>

    <script src="<?php echo e(asset('assets/js/pages/hr/admin/employees_letter_generate.js')); ?>"></script>
    

    <?php $__env->stopPush(); ?>
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\admin\letter\generate\create.blade.php ENDPATH**/ ?>