...
<div class="content">
    ...
    <div class="row">
        <div class="col-xl-8">
            <form action="<?php echo e(route ('sec.roles.update')); ?>" class="row g-3 mb-9 needs-validation" novalidate="" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\sec\roles\edit.blade.php ENDPATH**/ ?>