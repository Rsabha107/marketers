    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="business_address_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                ...
                data-url="<?php echo e(route('general.settings.address.list')); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/components/generalsettings/gs-addresses-card.blade.php ENDPATH**/ ?>