...
<input type="hidden" id="edit_vendor_id" name="id" value="<?php echo e($purchase->id); ?>">
<div>
                ...
                <div class="input-group">
                    ...
                    <div class="form-floating">
                        <input  class="form-control" 
                                name="po_number" 
                                type="text"
                                value="<?php echo e($purchase->po_number); ?>"
                ...
                <div class="form-floating">
                    <select name="vendor_id" class="form-select" id="add_vendor_id">
                        ...
                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $purchase->vendor_id ? 'selected' : ''); ?>>
                ...
                <div class="form-floating">
                    <select name="currency_id" class="form-select" id="add_currencyid">
                        ...
                        <?php $__currentLoopData = $currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $purchase->currency_id ? 'selected' : ''); ?>>
                ...
                <div class="flatpickr-input-container">
                    <div class="form-floating">
                        <input  class="form-control datetimepicker" 
                                ...
                                name="order_date"
                                value="<?php echo e($purchase->order_date); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views//procurement/admin/purchase/mv/edit.blade.php ENDPATH**/ ?>