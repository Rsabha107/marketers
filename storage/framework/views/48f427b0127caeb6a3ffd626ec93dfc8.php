...
<?php $__env->startSection('main'); ?>
    ...
    <div class="row gx-6 gy-3 mb-4 align-items-center">
        <div class="col-auto">
            <h2 class="mb-0">Projects<span class="fw-normal text-body-tertiary ms-3">(<?php echo e($project_data->count()); ?>)</span>
            </h2>
        </div>
    </div>
...
<?php echo $__env->make('projects.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\events\admin\event\list.blade.php ENDPATH**/ ?>