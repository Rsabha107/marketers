<!-- <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_form" novalidate="" action="<?php echo e(route ('hr.admin.employee.store')); ?>" method="POST"> -->
<!-- <?php echo csrf_field(); ?> -->
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="mb-3 row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <select class="form-select" name="sponsorship_id" id="edit_employee_sponsorship_id">
                        <option value="" selected>Select ...</option>
                ...
                <div class="col-md-6  mb-3">
                    ...
                    <input name="sponsorship_name" maxlength="70" id="edit_employee_sponsorship_name" class="form-control" type="text" placeholder="" value="<?php echo e($emp->sponsorship_name); ?>">
                    <!-- <div class="invalid-feedback">This field is required.</div> -->
                </div>
                <div class="mb-3 col-md-12">
        ...
        <div class="col-md-4">
            <div class="form-check form-switch mt-4 mb-4">
                <input class="form-check-input" id="flexSwitchCheckDefault" name="manager_flag" value="Y" type="checkbox" <?php echo e($emp->manager_flag? 'checked':''); ?> />
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\admin\employee\mv\edit.blade.php ENDPATH**/ ?>