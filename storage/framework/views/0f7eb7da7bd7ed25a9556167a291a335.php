                        ...
                        <div class="row align-items-center gx-0 gy-7">
                            <div class="col mx-auto">
                                <div class="auth-form-box">
                                    <div class="text-center mb-5"><a class="d-flex flex-center text-decoration-none mb-4" href="<?php echo e(route('tracki.employee.dashboard')); ?>">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="<?php echo e(route('tracki.sec.adminuser.create')); ?>" class="needs-validation validatedForm" novalidate>
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <!-- <div class="text-center"><a class="fs-9 fw-bold" href="<?php echo e(route('tracki.auth.login')); ?>">Sign in to an existing account</a></div> -->
                                        <div class="text-center"><a class="fs-9 fw-bold" href="<?php echo e(route('tracki.sec.adminuser.list')); ?>">Go back to list</a></div>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('tracki.event.layout.event-add-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\sec\adminuser\add.blade.php ENDPATH**/ ?>