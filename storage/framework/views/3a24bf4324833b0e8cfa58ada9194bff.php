...
<div class="card mt-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table  id="elementset_table"
                        data-toggle="table"
                        data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                        data-loading-template="loadingTemplate"
                        data-url="<?php echo e(route('hr.admin.setting.elementset.list')); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\element-set-card.blade.php ENDPATH**/ ?>