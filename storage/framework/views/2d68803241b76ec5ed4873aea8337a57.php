...
<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
    <div class="collapse navbar-collapse justify-content-between">
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="<?php echo e(route('hr.admin.employee')); ?>">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('assets/img/icons/sparkle_hrms.jpg')); ?>" alt="<?php echo e(__('traki.page_title')); ?>"
                            width="27" />
                        <h5 class="logo-text ms-2 d-none d-sm-block"><?php echo e(__('traki.page_title')); ?></h5>
                    </div>
                </div>
            </a>
        </div>
                        ...
                        <div class="list pb-3">
                            ...
                            <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                    ...
                                    <div class="file-thumbnail me-2"><img class="h-100 w-100 object-fit-cover rounded-3"
                                            src="<?php echo e(asset('fnx/assets/img/products/60x60/3.png')); ?>" alt="" />
                                    </div>
                                    <div class="flex-1">
                            ...
                            <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                    ...
                                    <div class="avatar avatar-l status-online  me-2 text-body">
                                        <img class="rounded-circle "
                                            src="<?php echo e(asset('fnx/assets/img/team/40x40/10.webp')); ?>" alt="" />
                                ...
                                <a class="dropdown-item py-2 d-flex align-items-center" href="pages/members.html">
                                    <div class="avatar avatar-l  me-2 text-body">
                                        <img class="rounded-circle "
                                            src="<?php echo e(asset('fnx/assets/img/team/40x40/12.webp')); ?>" alt="" />
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0 shadow border navbar-dropdown-caret"
                    ...
                    <div class="card position-relative border-0">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('projects.admin.task')); ?>"><span class="fas fa-plus me-2"></span>New Task</a>
                        <a class="dropdown-item" href="<?php echo e(route('hr.admin.employee')); ?>"><span class="fas fa-plus me-2"></span>New Employess</a>
                    </div>
                </div>
            </li>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    ...
                                                    src="<?php echo e(asset('fnx/assets/img/team/40x40/30.webp')); ?>"
                                                    alt="" />
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    ...
                                                    src="<?php echo e(asset('fnx/assets/img/team/40x40/avatar.webp')); ?>"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                                <h4 class="fs-9 text-body-emphasis">Jessie Samson</h4>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="<?php echo e(asset('fnx/assets/img/team/40x40/57.webp')); ?>"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="<?php echo e(asset('fnx/assets/img/team/40x40/59.webp')); ?>"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                ...
                                <div class="px-2 px-sm-3 py-3 notification-card position-relative read ">
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="<?php echo e(asset('fnx/assets/img/team/40x40/58.webp')); ?>"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                    ...
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle "
                            src="<?php echo e(!empty($profileData->photo) ? url('upload/admin_images/' . $profileData->photo) : url('upload/user_profile_Image.png')); ?>"
                            alt="" />
                    ...
                    <div class="card position-relative border-0">
                        ...
                        <div class="card-footer p-2">
                            ...
                            <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100"
                                    href="<?php echo e(route('logout')); ?>"> <span class="me-2"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\procurement\admin\body\header.blade.php ENDPATH**/ ?>