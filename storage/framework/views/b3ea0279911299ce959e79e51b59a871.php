                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <div class="d-flex align-items-center"><span
                                                                class="me-2 text-body-tertiary" 
                                                                ></span>
                                                            <p class="fw-semibold fs-9 mb-0 text-body-tertiary">Account Name
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                        ...
                        <div>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="deals-items-head d-flex align-items-center mb-2"><a
                                            class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7"
                                            href="#">Contacts <span>(<?php echo e($employee_data->emergency_contacts?->count()); ?>)</span></a>
                                        <p class="deals-category fs-10 mb-0 mt-1 d-none"><span
                                                class="me-1 text-body-quaternary" data-feather="grid"
                                                style="stroke-width:2; height: 12px; width: 12px"></span>Detail
                                        </p>
                                    ...
                                    <div class="collapse" id="collapseWidthDeals-5">
                                        <div class="border-top border-bottom border-translucent" id="customerOrdersTable" data-list='{"valueNames":["name","relationship","contact_number","workded","leaves","unpaid"],"page":6,"pagination":true}'>
                                            <div class="table-responsive scrollbar">
                                                <table class="table table-sm fs-9 mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th class="sort white-space-nowrap align-middle ps-0 pe-3" scope="col" data-sort="name" style="width:10%;">NAME</th>
                                                            <th class="sort align-middle text-end pe-7" scope="col" data-sort="relationship" style="width:10%;">RELATIONSHIP</th>
                                                            <th class="sort align-middle white-space-nowrap pe-3" scope="col" data-sort="contact_number" style="width:15%;">CONTACTS</th>
                                                    ...
                                                    <tbody class="list" id="customer-order-table-body">
                                                        ...
                                                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                            <td class="name align-middle white-space-nowrap ps-0"><a class="fw-semibold" href="#!"><?php echo e($item->first_name); ?> <?php echo e($item->last_name); ?></a></td>
                                                            <td class="relationship align-middle text-end fw-semibold pe-7 text-body-highlight"><?php echo e($item->relationships->title); ?></td>
                                                            <td class="contact_number align-middle text-end fw-semibold pe-7 text-body-highlight"><?php echo e($item->contact_number); ?></td>
                        ...
                        <div>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="deals-items-head d-flex align-items-center mb-2"><a
                                            class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7"
                                            href="#">Timesheets <span>(<?php echo e($employee_data->timesheets?->count()); ?>)</span></a>
                                        <p class="deals-category fs-10 mb-0 mt-1 d-none"><span
                                                class="me-1 text-body-quaternary" data-feather="grid"
                                                style="stroke-width:2; height: 12px; width: 12px"></span>Detail
                                        </p>
                                    ...
                                    <div class="collapse" id="collapseWidthDeals-6">
                                        <div class="border-top border-bottom border-translucent" id="customerOrdersTable" data-list='{"valueNames":["month","payment","timesheet_status","workded","leaves","unpaid"],"page":6,"pagination":true}'>
                                            <div class="table-responsive scrollbar">
                                                <table class="table table-sm fs-9 mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th class="sort white-space-nowrap align-middle ps-0 pe-3" scope="col" data-sort="month" style="width:10%;">MONTH</th>
                                                            <th class="sort align-middle text-end pe-7" scope="col" data-sort="payment" style="width:10%;">PAYMENT</th>
                                                            <th class="sort align-middle white-space-nowrap pe-3" scope="col" data-sort="timesheet_status" style="width:15%;">STATUS</th>
                                                    ...
                                                    <tbody class="list" id="customer-order-table-body">
                                                        ...
                                                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                            <td class="month align-middle white-space-nowrap ps-0"><a class="fw-semibold" href="#!"><?php echo e($item->timesheet_period); ?></a></td>
                                                            <td class="payment align-middle text-end fw-semibold pe-7 text-body-highlight"><?php echo e($item->total_payments); ?></td>
                                                            <td class="timesheet_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span class="badge badge-phoenix fs-10 badge-phoenix-<?php echo e($item->leave_statuses?->color); ?>"><span class="badge-label"><?php echo e($item->leave_statuses?->title); ?></span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                                                            <td class="workded align-middle text-end fw-semibold pe-7 text-body-highlight"><?php echo e($item->days_worked); ?></td>
                                                            <td class="leaves align-middle text-end fw-semibold pe-7 text-body-highlight"><?php echo e($item->leave_taken); ?></td>
                                                            <td class="unpaid align-middle text-end fw-semibold pe-7 text-body-highlight"><?php echo e($item->unpaid_leave_taken); ?></td>
                                                        </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('hr.emp.layout.emp_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\emp\dashboard.blade.php ENDPATH**/ ?>