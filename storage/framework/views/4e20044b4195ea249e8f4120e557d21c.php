...
<div class="modal-body">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <textarea style="height: 100px;"  maxlength="500" required name="reason" id="edit_reason" class="form-control tinymce1" data-tinymce="{}" placeholder=""><?php echo e($employee_leave->reason); ?></textarea>
        </div>
        <!-- </div> -->
    </div>
    <!-- end of left div -->
...
<!-- </form> -->
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\employee\leave\mv\edit.blade.php ENDPATH**/ ?>