<?php $__env->startSection('main'); ?>
  ...
  <body> -->
            ...
            <form class="row g-3 mb-6">
              ...
              <div class="col-12 gy-6">
                <div class="row g-3 justify-content-end">
                  ...
                  <div class="col-auto">
                  <a href="javascript:void(0);" id="add_edit_project" data-action="store" data-redirect="card" data-type="add" data-table="none" data-id="" data-workspace_id="<?php echo e(session()->get('workspace_id')); ?>" ><button type="button" class="btn btn-sm btn-primary ms-2 me-3" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title=" <?= get_label('create_project', 'Create project') ?>"><i class="bx bx-plus"></i></button></a>
    ...
    <script src="<?php echo e(asset('assets/js/pages/projects.js')); ?>"></script>


    <?php $__env->stopPush(); ?>

<?php echo $__env->make('main.event.layout.event-add-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\users\create-new.blade.php ENDPATH**/ ?>