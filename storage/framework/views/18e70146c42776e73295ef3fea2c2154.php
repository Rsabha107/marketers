...
<!-- ===============================================-->
    ...
    <div class="container-fluid">
        ...
        <form class="row g-3  px-3 needs-validation" id="update_employee_letter_form" novalidate="" action="<?php echo e(route ('hr.admin.letter.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\admin\letter\edit.blade.php ENDPATH**/ ?>