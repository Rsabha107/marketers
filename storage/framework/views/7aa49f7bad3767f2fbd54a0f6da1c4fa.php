...
<!-- ===============================================-->
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('tracki.employee.letter.generate')); ?>">
        ...
        <div class="row g-4">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="card border border-primary mb-3">
                    <div class="card-body">
                        <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_letter_form" novalidate="" action="<?php echo e(route ('tracki.employee.letter.generate.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-6">
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\employee\letter\generate\create.blade.php ENDPATH**/ ?>