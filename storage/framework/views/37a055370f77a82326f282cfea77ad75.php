...
<div class="container-small">
    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        ...
        <div>
            <a href="<?php echo e(route("procurement.admin.purchase.po.pdf.download", $header->id)); ?>" class="btn btn-phoenix-secondary me-2"><span class="fa-solid fa-download me-sm-2"></span><span class="d-none d-sm-inline-block">Download Invoice</span></a>
