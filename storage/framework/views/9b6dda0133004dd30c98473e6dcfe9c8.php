...
<div class="content">
    ...
    <div class="card shadow-none border my-4" data-component-card="data-component-card">
        ...
        <div class="p-4 code-to-copy">
            <form class="row g-3 needs-validation form-submit-eventx" novalidate id="add_new_client" action="<?php echo e(route('main.users.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                <!-- <form class="row g-3"> -->
                <div class="col-md-6">
...
<?php echo $__env->make('main.event.layout.event-add-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\users\create.blade.php ENDPATH**/ ?>