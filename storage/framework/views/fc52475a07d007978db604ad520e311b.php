...
<div class="mb-5">
    ...
    <?php else: ?>
    <?php $__currentLoopData = $task->notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="border-bottom border-dashed mb-3">
        <div class="d-flex align-items-center mb-3">
            <a href="#!">
                <div class="avatar avatar-xl me-2">
                    <img class="rounded-circle" src="<?php echo e(asset('assets/tracki/img//team/30.webp')); ?>" alt="" />
                </div>
            </a>
            <div class="flex-1">
                <a class="fw-bold mb-0 text-body-emphasis" href="#!"><?php echo e($note->user_name); ?></a>
                <p class="fs-10 mb-0 text-body-tertiary text-opacity-85 fw-semibold">
                    <?php echo e(Carbon\Carbon::parse($note->created_at)->format('d-M-Y h:m:i a')); ?>
            ...
            <div class="btn-reveal-trigger">
                ...
                <div class="dropdown-menu dropdown-menu-end py-2">
                    ...
                    <a class="dropdown-item text-danger removeNoteDiv" data-table="task_table" data-id="<?php echo e($note->id); ?>" href="#!">Delete</a>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\projects\admin\task\overview\notes.blade.php ENDPATH**/ ?>