        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('hr.emp.dashboard')); ?>">
                                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper">
                        <a
                            class="nav-link dropdown-indicator label-1 <?php echo e(Request::is('hr/*')||Request::is('hr/payroll/*') ? '' : 'collapsed'); ?>"
                            href="#nv-hrms"
                            role="button"
                            data-bs-toggle="collapse"
                            aria-expanded="<?php echo e(Request::is('hr/*') ? 'true' : 'false'); ?>"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul
                                class="nav collapse parent <?php echo e(Request::is('hr/*')||Request::is('tracki/setting/*')||Request::is('hr/payroll*') ? 'show' : ''); ?>"
                                data-bs-parent="#navbarVerticalCollapse"
                                id="nv-hrms">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link dropdown-indicator <?php echo e(Request::is('hr/manager/*') ? '' : 'collapsed'); ?>"
                                        href="#nv-manager"
                                        data-bs-toggle="collapse"
                                        aria-expanded="<?php echo e(Request::is('hr/manager/*') ? 'true' : 'false'); ?>"
                                    ...
                                    <div class="parent-wrapper">
                                        <ul
                                            class="nav collapse parent <?php echo e(Request::is('hr/manager*') ? 'show' : ''); ?>"
                                            data-bs-parent="#manager"
                                            id="nv-manager">
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link <?php echo e(Request::is('hr/manager') ? 'active' : ''); ?>"
                                                    href="<?php echo e(route('hr.manager')); ?>">
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link <?php echo e(Request::is('hr/manager/timesheet') ? 'active' : ''); ?>"
                                                    href="<?php echo e(route('hr.manager.timesheet')); ?>">
                                                    <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link dropdown-indicator <?php echo e(Request::is('hr/payroll/*') ? '' : 'collapsed'); ?>"
                                        href="#nv-payroll"
                                        data-bs-toggle="collapse"
                                        aria-expanded="<?php echo e(Request::is('hr/employee/*') ? 'true' : 'false'); ?>"
                                    ...
                                    <div class="parent-wrapper">
                                        <ul
                                            class="nav collapse parent <?php echo e(Request::is('hr/payroll*') ? 'show' : ''); ?>"
                                            data-bs-parent="#payroll"
                                            id="nv-payroll">
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link <?php echo e(Request::is('hr/payroll/timesheet') ? 'active' : ''); ?>"
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link <?php echo e(Request::is('hr/payroll/timesheet/missing') ? 'active' : ''); ?>"
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link <?php echo e(Request::is('hr/payroll/bank') ? 'active' : ''); ?>"
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link <?php echo e(Request::is('hr/payroll/payment') ? 'active' : ''); ?>"
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('tracki/employee/leave') ? 'active' : ''); ?> label-1"
                                        href="<?php echo e(route('tracki.employee.leave')); ?>" role="button">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Leaves</span>
                                        </div>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('hr/emp/timesheet') ? 'active' : ''); ?> label-1"
                                        href="<?php echo e(route('hr.emp.timesheet')); ?>" role="button">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('hr/emp/emergency') ? 'active' : ''); ?> label-1"
                                        href="<?php echo e(route('hr.emp.emergency')); ?>" role="button">
                                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper">
                        <a
                            class="nav-link dropdown-indicator label-1 <?php echo e(Request::is('tracki/sec/permissions/*')
                                                                        ||Request::is('tracki/sec/roles/*')
                                                                        ||Request::is('tracki/sec/groups/*') ? '' : 'collapsed'); ?>"
                            href="#nv-security-privacy"
                            role="button"
                            data-bs-toggle="collapse"
                            aria-expanded="<?php echo e(Request::is('tracki/sec/permissions/*')||Request::is('tracki/sec/roles/*')
                        ...
                        <div class="parent-wrapper label-1">
                            <ul
                                class="nav collapse parent <?php echo e(Request::is('tracki/sec/permissions/*')
                                                            ||Request::is('tracki/sec/roles/*')
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('tracki/sec/permissions/list') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('tracki.sec.perm.list')); ?>">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('tracki/sec/roles/roles/list') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('tracki.sec.roles.list')); ?>">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('tracki/sec/rolesetup/list') ? 'active' : ''); ?>"
                                        href=" <?php echo e(route('tracki.sec.rolesetup.list')); ?>">
                                        <div class="d-flex align-items-center">
                                ...
                                <!-- <li
                                    ...
                                    href="<?php echo e(route('tracki.sec.rolesetup.add')); ?>">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('tracki/sec/groups/groups/list') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('tracki.sec.groups.list')); ?>">
                                        <div class="d-flex align-items-center">
                    ...
                    <div class="nav-item-wrapper">
                        <a
                            class="nav-link dropdown-indicator label-1 <?php echo e(Request::is('tracki/sec/adminuser/*') ? '' : 'collapsed'); ?>"
                            href="#nv-manage-users"
                            role="button"
                            data-bs-toggle="collapse"
                            aria-expanded="<?php echo e(Request::is('tracki/sec/adminuser/*') ? 'true' : 'false'); ?>"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul
                                class="nav collapse parent <?php echo e(Request::is('tracki/sec/adminuser/*') ? 'show' : ''); ?>"
                                data-bs-parent="#navbarVerticalCollapse"
                                id="nv-manage-users">
                                <li class="collapsed-nav-item-title d-none">Manage Users</li>
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('tracki/sec/adminuser/list') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('tracki.sec.adminuser.list')); ?>">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link <?php echo e(Request::is('tracki/sec/adminuser/add') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('tracki.sec.adminuser.add')); ?>">
                                        <div class="d-flex align-items-center">
...
</nav><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\emp\body\sidebar.blade.php ENDPATH**/ ?>