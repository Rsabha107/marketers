...
<div class="card mt-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table  id="project_category_table"
                        data-toggle="table"
                        data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                        data-loading-template="loadingTemplate"
                        data-url="<?php echo e(route('projects.admin.setting.category.list')); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\projects\settings\category-card.blade.php ENDPATH**/ ?>