<?php if((Request::is('projects/admin/setting/category'))): ?>
    ...
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            <div class="modal-header bg-modal-header">
                ...
                <form class="needs-validation form-submit-event" id="add_project_category_form" novalidate="" action="<?php echo e(route('projects.admin.setting.category.store')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_project_category_modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation form-submit-event" id="edit_project_category_form" novalidate="" action="<?php echo e(route('projects.admin.setting.category.update')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
...
<?php if((Request::is('projects/admin/setting/tag'))): ?>
    ...
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            <div class="modal-header bg-modal-header">
                ...
                <form class="needs-validation form-submit-event" id="add_project_tag_form" novalidate="" action="<?php echo e(route('projects.admin.setting.tag.store')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="modal-body px-0">
                        <div class="row g-4">
...
<div class="modal fade" id="edit_project_tag_modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation form-submit-event" id="edit_project_tag_form" novalidate="" action="<?php echo e(route('projects.admin.setting.tag.update')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
...
<?php if((Request::is('projects/admin/setting/audience'))): ?>
...
<div class="modal fade" id="add_project_audience_modal" tabindex="-1" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="add_project_audience_form" novalidate="" action="<?php echo e(route('projects.admin.setting.audience.store')); ?>" method="POST" >
...
<div class="modal fade" id="edit_project_audience_modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation form-submit-event" id="edit_project_audience_form" novalidate="" action="<?php echo e(route('projects.admin.setting.audience.update')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
...
<?php if((Request::is('projects/admin/setting/venue'))): ?>
    ...
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            <div class="modal-header bg-modal-header">
                ...
                <form class="needs-validation form-submit-event" id="add_project_venue_form" novalidate="" action="<?php echo e(route('projects.admin.setting.venue.store')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="modal-body px-0">
                        <div class="row g-4">
...
<div class="modal fade" id="edit_project_venue_modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation form-submit-event" id="edit_project_venue_form" novalidate="" action="<?php echo e(route('projects.admin.setting.venue.update')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
...
<?php if((Request::is('projects/admin/setting/location'))): ?>
    ...
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            <div class="modal-header bg-modal-header">
                ...
                <form class="needs-validation form-submit-event" id="add_project_location_form" novalidate="" action="<?php echo e(route('projects.admin.setting.location.store')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="modal-body px-0">
                        <div class="row g-4">
...
<div class="modal fade" id="edit_project_location_modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation form-submit-event" id="edit_project_location_form" novalidate="" action="<?php echo e(route('projects.admin.setting.location.update')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
...
<?php if(Request::is('projects/admin/setting/departments')): ?>
<!-- departments modal -->
...
<?php if(Request::is('projects/admin/setting/funcareas')): ?>
<!-- venues modal -->
...
<?php if((Request::is('projects/admin/setting/projecttype'))): ?>
    ...
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            <div class="modal-header bg-modal-header">
                ...
                <form class="needs-validation form-submit-event" id="add_project_project_type_form" novalidate="" action="<?php echo e(route('projects.admin.setting.projecttype.store')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="modal-body px-0">
                        <div class="row g-4">
...
<div class="modal fade" id="edit_project_project_type_modal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation form-submit-event" id="edit_project_project_type_form" novalidate="" action="<?php echo e(route('projects.admin.setting.projecttype.update')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\projects\admin\partials\setup-modals.blade.php ENDPATH**/ ?>