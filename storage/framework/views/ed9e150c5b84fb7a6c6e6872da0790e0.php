    ...
    <main class="main" id="top">
        <div class="container">
            <div class="row flex-center min-vh-100 py-5">
                <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a class="d-flex flex-center text-decoration-none mb-4" href="<?php echo e(route('dashboard')); ?>">
                    ...
                    <div class="px-xxl-5">
                        <div class="text-center mb-6">
                            ...
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('forgot.password.post')); ?>" class="d-flex align-items-center mb-5">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\auth\forgot.blade.php ENDPATH**/ ?>