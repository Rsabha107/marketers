    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table  id="employee_timesheet_entry_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                    ...
                    data-url="<?php echo e(route('hr.admin.timesheet.entries.list', $timesheetId)); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\admin-employee-timesheet-entry-card.blade.php ENDPATH**/ ?>