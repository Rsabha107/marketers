                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <!-- <button class="btn btn-primary me-4" type="button" data-bs-toggle="modal"
                                            ...
                                            Deal</button> -->
                                        <a class="btn btn-sm btn-phoenix-primary preview-btn ms-2" href="<?php echo e(route('tracki.sec.roles.add')); ?>"><span class="fa-solid fa-add"></span>Add</a>
                                    </nav>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="<?php echo e(route('tracki.sec.roles.edit', $item->id)); ?>" class="btn btn-sm" id="secEditX" data-toggle="modal" data-target='#editModal' data-route="perm" data-id="<?php echo e($item->id); ?>">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="<?php echo e(route('tracki.sec.roles.delete',$item->id)); ?> " class="btn btn-sm delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="<?php echo e(route('tracki.sec.perm.create')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('tracki.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\sec\permissions\listx.blade.php ENDPATH**/ ?>