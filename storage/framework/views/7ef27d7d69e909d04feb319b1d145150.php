    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="vendor_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                ...
                data-url="<?php echo e(route('procurement.admin.vendor.list')); ?>"
                ...
                <thead>
                    <tr>
                        ...
                        <?php if(Auth()->user()->hasRole('SuperAdmin|HRMSADMIN')): ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/components/procurement/vendor/admin-vendor-card.blade.php ENDPATH**/ ?>