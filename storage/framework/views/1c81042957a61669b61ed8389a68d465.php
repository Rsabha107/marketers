    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table  id="payroll_bank_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                    ...
                    data-url="<?php echo e(route('hr.payroll.bank.list')); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\payroll-bank-card.blade.php ENDPATH**/ ?>