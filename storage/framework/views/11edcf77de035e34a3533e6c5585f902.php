...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.procurement.vendor.admin-drawer-vendor','data' => ['id' => '','formAction' => ''.e(route('procurement.vendor.store')).'','currency' => 'anything','formId' => 'add_vendor_form']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
