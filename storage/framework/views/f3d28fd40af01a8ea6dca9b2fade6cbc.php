...
<?php if(Request::is('hr/manager/timesheet*')||Request::is('hr/payroll/timesheet*')): ?>
...
<?php if(Request::is('hr/emp/timesheet/entries*')): ?>
<div class="modal fade" id="edit_employee_timesheet_entry_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_entry_form" novalidate="" action="<?php echo e(route ('hr.emp.timesheet.entries.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('hr/emp/timesheet') || Request::is('tracki/employee/profile*')): ?>
<div class="modal fade" id="add_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_form" novalidate="" action="<?php echo e(route ('hr.emp.timesheet.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="hidden" id="add_timesheet_employee_profile_id" name="employee_id" value="<?php echo e($employee_id); ?>">
...
<div class="modal fade" id="add_employee_profile_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_profile_form" novalidate="" action="<?php echo e(route ('hr.emp.timesheet.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" id="add_employee_timesheet_table_h" name="table" value="employee_timesheet_table">
...
<div class="modal fade" id="edit_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_form" novalidate="" action="<?php echo e(route ('hr.emp.timesheet.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="timesheetStatusModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" novalidate="" action="<?php echo e(route('hr.emp.timesheet.status.update')); ?>" method="POST" id="change_timesheet_status">
...
<?php if(Request::is('hr/emp/emergency') || Request::is('tracki/employee/profile*')): ?>
<div class="modal fade" id="add_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_emergency_form" novalidate="" action="<?php echo e(route ('hr.emp.emergency.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_emergency_form" novalidate="" action="<?php echo e(route ('hr.emp.emergency.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if(Request::is('tracki/setting/elementset')): ?>
<div class="modal fade" id="create_elementset_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_elementset_form" novalidate="" action="<?php echo e(route('tracki.setting.elementset.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_elementset_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_elementset_form" novalidate="" action="<?php echo e(route('tracki.setting.elementset.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\emp\partials\modals.blade.php ENDPATH**/ ?>