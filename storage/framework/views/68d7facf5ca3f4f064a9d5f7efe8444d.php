                                ...
                                <div class="col-sm-6 col-md-6  mb-3">
                                    <div class="form-floating">
                                        <select name="functional_area_id" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $functionalareas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option selected="selected" value="">Select...</option>
                                            <?php $__currentLoopData = $projecttype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(Request::old('id') == $item->id): ?>
                                            <option value="<?php echo e($item->id); ?>" selected>
                                                <?php echo e($item->name); ?>
                            ...
                            <div class="col-sm-6 col-md-12  mb-3">
                                <div class="form-floating">
                                    <select name="category_id" class="form-select" id="add_project_category">
                                        <option selected="selected" value="">Select...</option>
                                        <?php $__currentLoopData = $eventcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" selected>
                                            <?php echo e($item->name); ?>
...
unset($__errorArgs, $__bag); ?>" name="description" id="floatingProjectOverview" placeholder="Leave a comment here"
                            ...
                            <div class="col-12 gy-3 mb-3">
                                ...
                                <select class="form-select js-select-project-assign-multiple" id="add_project_assigned_to"
                            ...
                            <div class="col-sm-6 col-md-12  mb-3">
                                ...
                                <select class="form-select js-select-project-tags-multiple" id="add_project_tag"
...
</div><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\projects\admin-project-drawer.blade.php ENDPATH**/ ?>