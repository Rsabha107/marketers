            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('hr.admin.employee')); ?>"><?= get_label('employee', 'Employee') ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('hr.admin.timesheet')); ?>"><?= get_label('timesheet', 'timesheet') ?></a>
                        </li>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="d-sm-flex justify-content-between">
                                            ...
                                            <div class="d-flex mb-3">
                                                <a class="btn btn-subtle-danger me-1 mb-1" href="<?php echo e(route('hr.admin.timesheet')); ?>">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <form class="row g-3  px-3 needs-validation form-submit-event1" novalidate="" action="<?php echo e(route ('hr.admin.timesheet.entries.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\admin\timesheet\entries\add.blade.php ENDPATH**/ ?>