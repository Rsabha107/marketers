                        ...
                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    <h4 class="text-900 mb-0" data-anchor="data-anchor">Operation Type List</h4>
                                </div>
                                        ...
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden"
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="javascript:void(0)" class="btn btn-sm " id="editX" data-toggle="modal" data-target='#editModal' data-route="operation" data-id="<?php echo e($item->id); ?>">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="<?php echo e(route('tracki.setup.operation.delete',$item->id)); ?> " class="btn btn-sm  delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="<?php echo e(route('tracki.setup.operation.create')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="<?php echo e(route('tracki.setup.operation.update')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
...
<?php echo $__env->make('tracki.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\projects\admin\setting\operation-list.blade.php ENDPATH**/ ?>