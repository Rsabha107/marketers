                        ...
                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    <h4 class="text-900 mb-0" data-anchor="data-anchor">Person List</h4>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <!-- <button class="btn btn-primary me-4" type="button" data-bs-toggle="modal"
                                            ...
                                            Deal</button> -->
                                        <button class="btn btn-link px-2 text-900 copy-code-btn" data-bs-toggle="modal" data-bs-target="#addModal" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" type="button"><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2" id="personAddX"><span class="fa-solid fa-add"></span>Add</a>
                                    </nav>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive scrollbar mb-3">
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                            <thead class="text-900">
                                                <tr>
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">Name
                                                    </th>
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">email
                                                    </th>
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">phone
                                                    </th>
                                                    <th class="sort pe-1 align-middle white-space-nowrap" data-sort="customer" style="min-width: 2.5rem">Status
                                                    </th>
                                ...
                                <th class="no-sort"></th> -->
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-3"><?php echo e($item->email_address); ?></td>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="javascript:void(0)" class="btn btn-sm " id="personEditX" data-toggle="modal" data-target='#editModal' data-route="person" data-id="<?php echo e($item->id); ?>">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="<?php echo e(route('tracki.setup.person.delete',$item->id)); ?> " class="btn btn-sm  delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="<?php echo e(route('tracki.setup.person.create')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="modal-body px-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Email</label>
                                        <input class="form-control" type="email" placeholder="Enter email" name="email_address" id="addEmail"  />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Phone</label>
                                        <input class="form-control" type="phone" placeholder="Enter phone number" name="phone" id="addPhone"  />
                                    </div>
                                    <!-- <div class="mb-4">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" id="myButton" type="submit" data-loading-text="Loading...">Save</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="<?php echo e(route('tracki.setup.person.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Email</label>
                                        <input class="form-control" type="email" placeholder="Enter email" name="email_address" id="editEmail"  />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Phone</label>
                                        <input class="form-control" type="phone" placeholder="Enter phone number" name="phone" id="editPhone"  />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Status</label>
...
<?php echo $__env->make('tracki.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\projects\admin\setting\person-list.blade.php ENDPATH**/ ?>