        ...
        <div class="container col-8">
            <div class="theme-wizard flight-booking-wizard">
                <ul class="nav justify-content-between nav-wizard nav-wizard-success">
                    <?php $__currentLoopData = $project->tasks->where('milestone', '1')->sortBy('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone_task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($milestone_task->status?->title === 'Completed'): ?>
                            <?php
                        ...
                        <?php endif; ?>
                        <li class="nav-item">
                            <a class="<?php echo e($done_flag); ?> nav-link fw-semibold" data-toggle="tooltip"
                                title="<?php echo e($milestone_task->name); ?>" href="../../../apps/travel-agency/flight/homepage.html"
                                data-wizard-step="1">
                                <div class="d-inline-block text-center">
                                    <span class="nav-item-circle-parent">
                                        <span class="d-block nav-item-circle">
                                            <span class="<?php echo e($fa); ?>"></span>
                                        </span>
                                    </span>
                                    <span class="mt-1 fs-9"><?php echo e(Str::substr($milestone_task->name, 0, 7)); ?></span>
                                </div>
                            </a>
                        </li>
    ...
    <div class="row justify-content-between align-items-end mb-4 g-3">
        ...
        <div class="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div class="col-12 col-md-auto d-flex">
                <a href="javascript:void(0);" id="edit_project" data-id="<?php echo e($projectData->id); ?>"
                                                    ...
                                                    <div class="col-12 col-sm-auto flex-1">
                                                        <div class="d-flex align-items-center mb-3">
                                                            ...
                                                            <button class="btn btn-link p-0">
                                                                <a href="javascript:void(0);" id="edit_project"
                                                                    ...
                                                                    data-id="<?php echo e($projectData->id); ?>" data-redirect="list"
                                                            ...
                                                            <div>
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <p class="text-body-emphasis fw-semibold">
                                                                        <?php echo e(number_format($projectData->budget_allocation)); ?>
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <p class="text-body-emphasis fw-semibold">
                                                                        <?php echo e(number_format($remainingBudget)); ?>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center mb-3 mb-md-0 mb-xl-3">
                                                                <div class="avatar avatar-xl me-3"><img
                                                                        ...
                                                                        alt="" /></div>
                                                                <div>
                                                                    <h5><?php echo e($projectData->client?->first_name . ' ' . $projectData->client?->last_name); ?>
                                                                                ...
                                                                                <div class="card-body p-0">
                                                                                    <div class="mx-3">
                                                                                        <form id="switchClientOwner"
                                                                                            ...
                                                                                            novalidate=""
                                                                                            action="<?php echo e(route('projects.admin.project.update.client')); ?>"
                                                                                            method="POST">
                                                                                            <?php echo csrf_field(); ?>
                                                                                            <input type="hidden"
                                                                                                name="project_id"
                                                                                            ...
                                                                                            <select id="change_client"
                                                                                                ...
                                                                                                data-id = "<?php echo e($projectData->id); ?>"
                                                        ...
                                                        <div class="progress bg-success-100">
                                                            <div class="progress-bar rounded bg-<?php echo e($projectData->status->color); ?>"
                                                                ...
                                                                style="width: <?php echo e($project_progress); ?>%"
                                                        ...
                                                        <?php $__currentLoopData = $projectData->employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($emp->emp_files?->file_path): ?>
                                                                <div class="d-flex align-items-center mb-3"><a
                                                                        href="#!" role="button"
                                                                        title="<?php echo e($emp->full_name); ?>">
                                                                    ...
                                                                    <div><a class="fs-8 fw-bold"
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <p
                                                                                ...
                                                                                <?php echo e($emp->designation->name); ?>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-body-secondary mb-4">
                                                <?php echo e(strip_tags($projectData->description)); ?>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        <?php echo e($projectData->functional_area?->name ? $projectData->functional_area?->name : 'not specified'); ?>
                                            ...
                                            <div class="card h-100">
                                                <div class="card-body d-flex flex-column">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <h4><?php echo e(number_format($total_budget_spent)); ?></h4>
                                                    </div>
                                                    <div class="d-flex justify-content-center pt-3 flex-1">
                                                        <div class="echarts-budget-utilization"
                                                            style="height:100%;width:100%;"
                                                            data-percent="<?php echo e(number_format($budget_percentage_used, 2)); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="mt-3">
                                                        <div class="d-flex align-items-center mb-2">
                                                            ...
                                                            <h6 class="text-body fw-semibold mb-0">
                                                                <?php echo e(number_format($budget_percentage_used, 2)); ?>%
                                                            </h6>
                                                        </div>
                                                        <!-- <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <select class="form-select select-appearance" id="tasks_employee_filter"
                                        ...
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key->id); ?>"><?php echo e($key->first_name); ?>

                                                <?php echo e($key->last_name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.projects.admin-tasks-card','data' => ['projectId' => $projectData->id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['projectId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($projectData->id)]); ?>
...
<?php endif; ?>
                    ...
                    <div class="tab-pane fade h-100" id="ganttTabContent" role="tabpanel" aria-labelledby="ganttTab">
                        ...
                        <div>
                            <?php if (isset($component)) { $__componentOriginal25c937b58b86c2eb98fbe6e5ff2abedc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal25c937b58b86c2eb98fbe6e5ff2abedc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-project-gantt-card','data' => ['project' => $projectData]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin-project-gantt-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['project' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($projectData)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal25c937b58b86c2eb98fbe6e5ff2abedc)): ?>
<?php $attributes = $__attributesOriginal25c937b58b86c2eb98fbe6e5ff2abedc; ?>
<?php unset($__attributesOriginal25c937b58b86c2eb98fbe6e5ff2abedc); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal25c937b58b86c2eb98fbe6e5ff2abedc)): ?>
<?php $component = $__componentOriginal25c937b58b86c2eb98fbe6e5ff2abedc; ?>
<?php unset($__componentOriginal25c937b58b86c2eb98fbe6e5ff2abedc); ?>
<?php endif; ?>
                        </div>
                    </div>
                    <!--======================================
                    ...
                    <div class="tab-pane fade h-100" id="kanbanTabContent" role="tabpanel" aria-labelledby="kanbanTab">
                        ...
                        <div>
                            <?php if (isset($component)) { $__componentOriginal465cf8d1933a42ef400e1af78e6438cb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal465cf8d1933a42ef400e1af78e6438cb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-project-kanban-card','data' => ['project' => $projectData,'taskStatuses' => $statuses,'tasks' => $tasks]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin-project-kanban-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['project' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($projectData),'taskStatuses' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($statuses),'tasks' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tasks)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal465cf8d1933a42ef400e1af78e6438cb)): ?>
<?php $attributes = $__attributesOriginal465cf8d1933a42ef400e1af78e6438cb; ?>
<?php unset($__attributesOriginal465cf8d1933a42ef400e1af78e6438cb); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal465cf8d1933a42ef400e1af78e6438cb)): ?>
<?php $component = $__componentOriginal465cf8d1933a42ef400e1af78e6438cb; ?>
<?php unset($__componentOriginal465cf8d1933a42ef400e1af78e6438cb); ?>
<?php endif; ?>
                        </div>
                    </div>
                    <!--======================================
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="d-xl-flex justify-content-between mb-3">
                                <a href="javascript:void(0);">
                                    <button type="button" id="add_project_member" data-id="<?php echo e($projectData->id); ?>"
                            ...
                            <div class="mb-0">
                                <?php if (isset($component)) { $__componentOriginale021f79a5002a5b49ec5e9c04798958d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale021f79a5002a5b49ec5e9c04798958d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-project-members-card','data' => ['users' => $users,'projectId' => $projectData->id,'statuses' => $statuses,'departments' => $departments,'source' => 'list','showpage' => 'list','showpageid' => 'list_'.e($projectData->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin-project-members-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale021f79a5002a5b49ec5e9c04798958d)): ?>
<?php $attributes = $__attributesOriginale021f79a5002a5b49ec5e9c04798958d; ?>
<?php unset($__attributesOriginale021f79a5002a5b49ec5e9c04798958d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginale021f79a5002a5b49ec5e9c04798958d)): ?>
<?php $component = $__componentOriginale021f79a5002a5b49ec5e9c04798958d; ?>
<?php unset($__componentOriginale021f79a5002a5b49ec5e9c04798958d); ?>
<?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('projects.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\projects\admin\project\d.blade.php ENDPATH**/ ?>