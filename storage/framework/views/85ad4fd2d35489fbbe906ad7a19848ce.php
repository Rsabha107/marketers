...
<!-- ===============================================-->
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('tracki.project.show.card')); ?>">
    ...
    <div class="row justify-content-between align-items-end mb-4 g-3">
        <div class="col-12 col-sm-auto">
            <h2 class="mb-0"><?php echo e(__('traki.employee.create_employee')); ?><span class="fw-normal text-700 ms-3"></span></h2>
        </div>
        <div class="col-12 col-sm-auto">
                                    ...
                                    <div class="mb-2 row">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="employee_type" id="add_employee_employee_type" required="required">
                                                ...
                                                <?php $__currentLoopData = $employee_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\admin\employee\create.blade.php ENDPATH**/ ?>