<div class="card mb-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="employee_generated_letter_table" 
                data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                data-toggle="table" 
                data-loading-template="loadingTemplate"
                data-url="<?php echo e(route('hr.admin.letter.generate.list', $employeeid)); ?>"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-sortable="true" data-field="employee_name"><?= get_label('employee', 'Employee') ?></th>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\admin-generated-letter-template-card.blade.php ENDPATH**/ ?>