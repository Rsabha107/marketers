    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="employee_salary_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                ...
                data-url="<?php echo e(route('tracki.employee.salary.list', $employeeid )); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\employee-profile-salary-card.blade.php ENDPATH**/ ?>