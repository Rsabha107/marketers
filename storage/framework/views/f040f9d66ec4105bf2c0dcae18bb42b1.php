    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table
                ...
                data-search="true"
                data-url="<?php echo e(route('projects.admin.project.list')); ?>"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-sortable="false" data-field="project_type"><?= get_label('project_type', 'Type') ?></th>
    ...
    function customViewFormatter(data) {
        ...
        $.each(data, function(i, row) {
            view += template
                ...
                .replace("%PROJECTSTATUSCARD%", row.project_status_card)
                .replace("%PROJECTTYPECARD%", row.project_type_card)
...
</script><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/components/projects/admin-projects-card.blade.php ENDPATH**/ ?>