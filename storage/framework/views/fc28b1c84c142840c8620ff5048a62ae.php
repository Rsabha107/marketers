        ...
        <div class="mb-9">
          ...
          <div id="orderTable" data-list='{"valueNames":["order","total","customer","payment_status","fulfilment_status","delivery_type","date"],"page":10,"pagination":true}'>
            ...
            <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white border-top border-bottom border-200 position-relative top-1">
              ...
              <div class="table table-responsive table-sm fs--1 mb-0">
                            <table id="dataList" class="table border-0 table-hover table-center mb-0">
...
<div class="modal fade contentmodal" id="plannerDelete" tabindex="-1" aria-hidden="true">
    ...
    <!-- <script>
        $(document).on('click','.planner_delete',function()
        {
...
<?php echo $__env->make('main.partials.report-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('main.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\report.blade.php ENDPATH**/ ?>