...
<div class="content">
    ...
    <div class="card shadow-none border my-4" data-component-card="data-component-card">
        ...
        <div class="p-4 code-to-copy">
            <form class="row g-3 needs-validation form-submit-eventx" novalidate id="add_new_client" action="<?php echo e(route('tracki.client.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                <!-- <form class="row g-3"> -->
                <div class="col-md-6">
                    <label class="form-label" for="inputEmail4">First name</label>
                    <input class="form-control" id="first_name" name="first_name" type="text" value="<?php echo e(old('first_name')); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="inputEmail4">Last name</label>
                    <input class="form-control" id="last_name" name="last_name" type="text" value="<?php echo e(old('last_name')); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="inputEmail4">Email</label>
                    <input class="form-control" id="inputEmail4" name="email" type="email" value="<?php echo e(old('email')); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="inputEmail4">Phone number</label>
                    <input class="form-control" id="phone_number" name="phone" type="phone" value="<?php echo e(old('phone')); ?>" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" id="company" name="company" type="text" placeholder="1234 Main St" value="<?php echo e(old('company')); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="inputAddress2">Address</label>
                    <input class="form-control" id="address" name="address" type="text" placeholder="Apartment, studio, or floor" value="<?php echo e(old('address')); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="inputAddress2">Country</label>
                    <input class="form-control" id="country" name="country" type="text" placeholder="Apartment, studio, or floor" value="<?php echo e(old('country')); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="inputCity">City</label>
                    <input class="form-control" id="inputCity" name="city" type="text" value="<?php echo e(old('city')); ?>" required>
                </div>
                <div class="col-md-6">

                    <label class="form-label" for="inputState">State</label>

                    <select class="form-select" id="inputState" name="state" value="<?php echo e(old('state')); ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" id="inputZip" name="zipcode" type="text" value="<?php echo e(old('zipcode')); ?>" required>
                </div>
...
<?php echo $__env->make('tracki.event.layout.event-add-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\clients\create.blade.php ENDPATH**/ ?>