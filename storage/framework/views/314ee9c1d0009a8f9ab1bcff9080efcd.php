...
html += '<?php $__currentLoopData = $item_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>';
html += '<?php if(Request::old("item_category") == $item_cat->item_category_id ): ?>';
html += '<option value="<?php echo e($item_cat->item_category_id); ?>" selected>';
html += ' <?php echo e($item_cat->item_category_name); ?>';
html += "</option>";
html += '<?php else: ?>';
html += "<option value='<?php echo e($item_cat->item_category_id); ?>'>";
html += '<?php echo e($item_cat->item_category_name); ?>';
html += '</option>';
html +=  '<?php endif; ?>';
...
$("#productTable").append(html);
    ...
    $(document).on("change", "#floatingSiteType", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.sitecategory')); ?>",
            data: {
                venue_type_id: id,
    ...
    $(document).on("change", "#floatingSiteCategory", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.sitecode')); ?>",
            data: {
                venue_id: id,
                _token: "<?php echo e(csrf_token()); ?>",
            },
    ...
    $(document).on("change", "#floatingSiteCode", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.sitename')); ?>",
            data: {
                site_id: id,
                _token: "<?php echo e(csrf_token()); ?>",
            },
    ...
    $(document).on("change", "#floatingLogicalSpaceCategory", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.ls_subcat')); ?>",
            data: {
                category_id: id,
                _token: "<?php echo e(csrf_token()); ?>",
            },
    ...
    $(document).on("change", "#floatingLogicalspaceSubcategory", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.lsname')); ?>",
            data: {
                subcat_id: id,
                _token: "<?php echo e(csrf_token()); ?>",
            },
    ...
    $(document).on("change", "#floatingLogicalspaceName", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.lscode')); ?>",
            data: {
                logical_space_id: id,
                _token: "<?php echo e(csrf_token()); ?>",
            },
    ...
    $(document).on("change", ".item_category", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.itemsubcategory')); ?>",
            data: {
                item_category_id: id,
                _token: "<?php echo e(csrf_token()); ?>",
            },
    ...
    $(document).on("change", ".item_subcategory", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo e(route('main.get.itemname')); ?>",
            data: {
                item_subcat_id: id,
                _token: "<?php echo e(csrf_token()); ?>",
            },
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\partials\order-form-js.blade.php ENDPATH**/ ?>