            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('tracki.client.manage')); ?>"><?= get_label('clients', 'Clients') ?></a>
                        </li>
...
<?php echo $__env->make('tracki.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\clients\all.blade.php ENDPATH**/ ?>