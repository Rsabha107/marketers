        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-home">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                                ...
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.dashboard')); ?>" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1 active" href="#nv-marketing" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-marketing">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-marketing">
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-events" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-events">
                                    ...
                                    <div class="parent-wrapper">
                                        <ul class="nav collapse parent shw" data-bs-parent="#marketing" id="nv-events">
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.project.show.card','')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Show</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <?php if(Auth::user()->can('project.create')): ?>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.project.add')); ?>" data-bs-toggle="" aria-expanded="false">
                                            ...
                                            <?php endif; ?>
                                            <?php if(Auth::user()->can('project.archive')): ?>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.project.show.archive')); ?>" data-bs-toggle="" aria-expanded="false">
                                            ...
                                            <?php endif; ?>
                                            <?php if(Auth::user()->can('gantt.menu')): ?>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('gantt')); ?>" target="_blank" data-bs-toggle="" aria-expanded="false">
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-tasks" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-tasks">
                                    ...
                                    <div class="parent-wrapper">
                                        <ul class="nav collapse parent shw" data-bs-parent="#marketing" id="nv-tasks">
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.task.manage')); ?>" data-bs-toggle="" aria-expanded="false">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.task.lt')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Late</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.task.est')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Ending Soon</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.task.sst')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Starting Soon</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.kanban.show.task',11)); ?>" data-bs-toggle="" aria-expanded="false">
                                ...
                                <?php if(Auth::user()->can('budget.all')): ?>
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-budget" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-budget">
                                    ...
                                    <div class="parent-wrapper">
                                        <ul class="nav collapse parent shw" data-bs-parent="#marketing" id="nv-budget">
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.budget.utilization')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Utilization</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.budget')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Budget Names</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.budget.fam.list')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Budget/FA Mapping</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.budget.list')); ?>" data-bs-toggle="" aria-expanded="false">
                                ...
                                <?php endif; ?>
                                <?php if(Auth::user()->can('attendance.menu')): ?>
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-attendance" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-attendance">
                                    ...
                                    <div class="parent-wrapper">
                                        <ul class="nav collapse parent shw" data-bs-parent="#marketing" id="nv-attendance">
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.attendance.list')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Master list</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.attendance.assignment')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Assign to event</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.attendance.checkin')); ?>" data-bs-toggle="" aria-expanded="false">
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-setup" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-setup">
                                    ...
                                    <div class="parent-wrapper">
                                        <ul class="nav collapse parent shw" data-bs-parent="#marketing" id="nv-setup">
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.category')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Event category</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.audience')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Audience</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.planner')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Planner</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.venue')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Venue</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.location')); ?>" data-bs-toggle="" aria-expanded="false">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.department')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Departments</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.person')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Person</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.priority.manage')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Priority</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.projecttype')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Project Type</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.status.manage')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Status</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.fundcategory')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Fund Category</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.fa')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Functional Area</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.workspace')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Workspace</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.operation')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Operation Type</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.segment')); ?>" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span class="nav-link-text">Segment</span>
                                                    </div>
                                                </a>
                                                <!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.color')); ?>" data-bs-toggle="" aria-expanded="false">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link label-1" href="<?php echo e(route('main.todo.manage')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-roleperm" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-roleperm">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-roleperm">
                                ...
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.sec.perm.list')); ?>" data-bs-toggle="" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">All Permissions</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.sec.roles.list')); ?>" data-bs-toggle="" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">All Roles</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.sec.rolesetup.list')); ?>" data-bs-toggle="" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">List Roles in Permission</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.sec.rolesetup.add')); ?>" data-bs-toggle="" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">Role in Permission</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.sec.groups.list')); ?>" data-bs-toggle="" aria-expanded="false">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-adminuser" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-adminuser">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-adminuser">
                                ...
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.sec.adminuser.list')); ?>" data-bs-toggle="" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">All Users</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.sec.adminuser.add')); ?>" data-bs-toggle="" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">Add User</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('main.setup.usertype')); ?>" data-bs-toggle="" aria-expanded="false">
                    ...
                    <?php endif; ?>
                    <?php if(Auth::user()->can('user.addx')): ?>
                    <!-- parent pages-->
                    <!-- ******************************** Kanbad and Calendar  ******************************** -->
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link label-1" href="<?php echo e(route('main.auth.signup')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <?php endif; ?>
                    <?php if(Auth::user()->can('calendar.menu')): ?>
                    <div class="nav-item-wrapper"><a class="nav-link label-1" href="<?php echo e(route('main.project.show.calendar')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\partials\sidebar.blade.php ENDPATH**/ ?>