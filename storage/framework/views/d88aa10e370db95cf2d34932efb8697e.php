<?php if((Request::is('projects/admin/project') || Request::is('tracki/users/create-new') || Request::is('tracki/task/*/list')) || Request::is('tracki/employee/profile*') && !Request::is('tracki/project/archive')): ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\events\admin\partials\project_modals.blade.php ENDPATH**/ ?>