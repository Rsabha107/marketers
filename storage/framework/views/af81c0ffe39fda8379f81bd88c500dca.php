    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="employee_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                ...
                data-url="<?php echo e(route('hr.admin.employee.list')); ?>"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-sortable="true" data-field="entity_id"><?= get_label('entity', 'Entity') ?></th>
                        ...
                        <th data-sortable="true" data-field="work_email_address"><?= get_label('email', 'Email') ?></th>
                        <!-- <th data-sortable="true" data-field="employee_type"><?= get_label('employee_type', 'Emp Type') ?></th> -->
                        <th data-sortable="true" data-field="reporting_to_id"><?= get_label('reporting_to', 'Supervisor Name') ?></th>
                        <th data-sortable="true" data-field="gender_id"><?= get_label('gender', 'Gender') ?></th>
                        <th data-sortable="false" data-field="salary"><?= get_label('salary', 'Base Salary') ?></th>
                        ...
                        <th data-sortable="true" data-field="designation_id" data-visible="false"><?= get_label('job', 'Job') ?></th>
                        <th data-sortable="true" data-field="job_level_id" data-visible="false"><?= get_label('job_level', 'Job Level') ?></th>
                        <th data-sortable="true" data-field="sponsorship_id" data-visible="false"><?= get_label('sponsorship_id', 'Sponsorship') ?></th>
                        <th data-sortable="true" data-field="sponsorship_name" data-visible="false"><?= get_label('sponsorship_name', 'Sponsorship Name') ?></th>
                        ...
                        <th data-sortable="true" data-field="directorate_id" data-visible="false"><?= get_label('directorate', 'Directorate') ?></th>
                        <th data-sortable="true" data-field="department_id" data-visible="false"><?= get_label('department', 'Department') ?></th>
                        <th data-sortable="true" data-field="functional_area_id" data-visible="false"><?= get_label('functional_area', 'Functional Area') ?></th>
                        <th data-sortable="true" data-field="marital_status_id" data-visible="false"><?= get_label('marital_status', 'Marital Status') ?></th>
                        ...
                        <th data-sortable="true" data-field="countract_type_id" data-visible="false"><?= get_label('countract_type', 'Countract Type') ?></th>
                        <th data-sortable="true" data-field="manager_flag" data-visible="false"><?= get_label('manager_flag', 'Manager?') ?></th>
                        <th data-sortable="false" data-field="user_name" data-visible="false"><?= get_label('user_name', 'User Name') ?></th>
...
</div><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\admin-employees-card.blade.php ENDPATH**/ ?>