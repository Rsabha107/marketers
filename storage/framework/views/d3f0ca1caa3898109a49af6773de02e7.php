    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table table-stripped id="task_table"
                ...
                data-url="<?php echo e(route('projects.admin.employee.task.list', $empId)); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\admin-employee-tasks-card.blade.php ENDPATH**/ ?>