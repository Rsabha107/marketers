<div class="modal fade" id="add_currency" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_currency_form" novalidate="" action="<?php echo e(route('general.settings.currency.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_currency_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_currency_form" novalidate="" action="<?php echo e(route('general.settings.currency.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<!-- </div> --><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/general/settings/partials/gs_currency_modal.blade.php ENDPATH**/ ?>