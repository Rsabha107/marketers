<div class="card mb-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="purchase_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                data-toggle="table" data-loading-template="loadingTemplate"
                data-url="<?php echo e(route('procurement.admin.purchase.list')); ?>"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-sortable="true" data-field="po_number"><?= get_label('po_number', 'PO Number') ?></th>
                        <th data-sortable="true" data-field="vendor_id"><?= get_label('Vendor', 'Vendor') ?></th>
                        <th data-sortable="true" data-field="order_date"><?= get_label('po_date', 'Purchase Date') ?></th>
                        <th data-sortable="true" data-field="expected_delivery_date"><?= get_label('expected_delivery_date', 'Expected Date') ?></th>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\procurement\purchase\admin-purchase-card.blade.php ENDPATH**/ ?>