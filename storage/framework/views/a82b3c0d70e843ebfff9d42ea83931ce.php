        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('hr.emp.employee')); ?>">
                            <?= get_label('employees', 'Employees') ?></a>
                    </li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('hr.emp.timesheet')); ?>">
...
<script src="<?php echo e(asset('assets/js/pages/hr/emp/employees_timesheet_entry.js')); ?>"></script>
...
<?php echo $__env->make('hr.emp.layout.emp_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\emp\timesheet\entries\list.blade.php ENDPATH**/ ?>