...
<?php $__env->startSection('main'); ?>
    ...
    <div class="mb-9" data-bs-spy="scroll" data-bs-target="#widgets-scrollspy">
        <div class="d-flex mb-5 pt-8" id="scrollspyStats"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-primary"></i><i class="fa-inverse fa-stack-1x text-primary-subtle fas fa-percentage"></i></span>
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-body pe-2">(ADMIN) Number Stats &amp; Charts</span><span class="border border-primary-lighter position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h3>
        ...
        <div class="px-3 mb-5">
            <div class="row justify-content-between">
                <div class="col-6 col-md-4 col-xxl-2 text-center border-translucent border-start-xxl border-end-xxl-0 border-bottom-xxl-0 border-end border-bottom pb-4 pb-xxl-0 "><span class="uil fs-5 lh-1 uil-books text-primary"></span>
                    <h1 class="fs-5 pt-3"><a href="<?php echo e(route('hr.admin.employee')); ?>"> <?php echo e($employee_count); ?> </a></h1>
...
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views/hr/admin/dashboard.blade.php ENDPATH**/ ?>