                        ...
                        <div class="row align-items-center gx-0 gy-7">
                            <div class="col mx-auto">
                                <div class="auth-form-box">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="<?php echo e(route('tracki.sec.adminuser.update')); ?>" class="needs-validation validatedForm" novalidate>
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\sec\adminuser\edit.blade.php ENDPATH**/ ?>