<div class="card mb-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table  id="payroll_payment_table" data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                    data-toggle="table" data-loading-template="loadingTemplate"
                    data-url="<?php echo e(route('tracki.payroll.payment.list')); ?>"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-sortable="true" data-field="directorate"><?= get_label('directorate', 'Directorate') ?></th>
                        <th data-sortable="true" data-field="job_level"><?= get_label('job_level', 'Position') ?></th>
                        <th data-sortable="true" data-field="line_manager"><?= get_label('line_manager', 'Line Manager') ?></th>
                        <th data-sortable="true" data-field="fee_package"><?= get_label('fee_package', 'Fee Package') ?></th>
                        <th data-sortable="true" data-field="total_payment"><?= get_label('invoice_amount', 'Invoice Amount') ?></th>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\payroll-payment-list-card.blade.php ENDPATH**/ ?>