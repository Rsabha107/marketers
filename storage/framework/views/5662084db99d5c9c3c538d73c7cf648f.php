...
<body>
    <form  action="<?php echo e(route ('main.sec.adminuser.mupdate')); ?>" method="post">
    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\manualupdateadminuser.blade.php ENDPATH**/ ?>