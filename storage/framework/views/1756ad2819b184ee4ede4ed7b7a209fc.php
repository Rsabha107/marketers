<?php if((Request::is('projects/admin/project') || Request::is('projects/admin/project/d*') || Request::is('tracki/task/*/list')) || Request::is('tracki/employee/profile*') && !Request::is('tracki/project/archive')): ?>
    ...
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content bg-body-highlight">
            <div class="modal-header bg-modal-header">
                <h3 class="mb-0" id="add_project_modal_label"><?= get_label('create_project', 'Create project') ?></h3>
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_project_form" novalidate="" action="<?php echo e(route ('project.create')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        ...
                        <select name="workspace_id" class="form-select" id="add_project_workspace_id" required style="background-color: #ADC5FF;">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="fund_category_id" class="form-select" id="add_project_fund" required>
                                <option selected="selected" value="">Select...</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="budget_name_id" class="form-select" id="add_project_budget" required>
                                <option selected="selected" value="">Select...</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control datetimepicker" id="add_project_start_date" data-target="#floatingInputStartDate" name="start_date" type="date" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true,"dateFormat":"d/m/Y"}' required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="inputEmail4">End Date</label>
                            <input class="form-control datetimepicker" id="add_project_end_date" data-target="#floatingInputStartDate" name="end_date" type="date" placeholder="dd/mm/yyyy" data-options='{"disableMobile":true,"dateFormat":"d/m/Y"}' required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="budget_allocation" class="form-control" id="add_project_budget_allocation" type="number" step="0.01" placeholder="" value="0" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="inputState">Attendance forcast</label>
                            <input name="attendance_forcast" class="form-control" id="add_project_attendance" type="number" step="0.01" placeholder="" value="0" required>
                        </div>
                    </div>
                    <div class="col-md-12">
...
<div class="modal fade" id="edit_project_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content bg-body-highlight">
            <div class="modal-header bg-modal-header">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_edit_project_form" novalidate="" action="<?php echo e(route ('project.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addTaskNoteModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="add_new_task_note" novalidate="" action="<?php echo e(route('projects.admin.task.note.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="modal-body px-0">
                        <div class="row g-4">
...
<div class="modal fade" id="taskStatusModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" novalidate="" action="<?php echo e(route('projects.admin.task.status.update')); ?>" method="POST" id="task_status">
...
<div class="modal fade" id="add_task_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content bg-body-highlight">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_task_form" novalidate="" action="<?php echo e(route ('projects.admin.task.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="edit_task_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content bg-body-highlight">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_task_form" novalidate="" action="<?php echo e(route ('projects.admin.task.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="offcanvas offcanvas-start" id="offcanvasCreateSubTask" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body">
        ...
        <form class="row g-3 needs-validation form-submit-event" id="add_new_task" novalidate="" action="<?php echo e(route('projects.admin.task.subtask.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php if(Request::is('tracki/task/*/list')): ?>
...
<div class="modal fade" id="createSubTaskModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="add_new_subtasktask" novalidate="" action="<?php echo e(route('projects.admin.task.subtask.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="modal-body px-0">
                        <div class="row g-4">
                            ...
                            <div class="tab-content mt-3" id="myTabContent">
                                <div class="tab-pane fade active show" id="tab-task-note" role="tabpanel" aria-labelledby="task-note-tab">
                                    ...
                                    <div class="collapse" id="collapseTaskNote">
                                        <form class="needs-validation form-submit-task-new-note" novalidate="" action="<?php echo e(route('projects.admin.task.note.store')); ?>" method="POST" id="form_submit_task_new_note">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="tab-pane fade" id="tab-task-file" role="tabpanel" aria-labelledby="task-file-tab">
                                    ...
                                    <div class="collapse" id="collapseTaskFile">
                                        ...
                                        <form id="form_submit_task_new_file" class="needs-validation form-submit-task-new-file" novalidate="" action="<?php echo e(route('projects.admin.task.file.store')); ?>" method="POST" enctype='multipart/form-data'>
                                            <?php echo csrf_field(); ?>
                                            <div class="modal-body">
                                                <div class="modal-body px-0">
                                                    <div class="row g-4">
                                ...
                                <div class="tab-pane fade" id="tab-task-subtask" role="tabpanel" aria-labelledby="task-subtask-tab">
                                    ...
                                    <div class="collapse" id="collapseTaskSubtask">
                                        ...
                                        <form class="needs-validation form-submit-task-new-subtask" id="form_submit_task_new_subtask" novalidate="" action="<?php echo e(route('projects.admin.task.subtask.store')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="modal-body">
                                                <div class="modal-body px-0">
                                                    <div class="row g-4">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\events\admin\partials\modals.blade.php ENDPATH**/ ?>