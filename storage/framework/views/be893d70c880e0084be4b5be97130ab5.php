...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset ('assets/tracki/img/favicons/apple-touch-icon.jpg')); ?>">
    <link rel="icon" type="image/jpg" sizes="32x32" href="<?php echo e(asset ('assets/tracki/img/favicons/sparkle_hrms.jpg')); ?>">
    <link rel="icon" type="image/jpg" sizes="16x16" href="<?php echo e(asset ('assets/tracki/img/favicons/sparkle_hrms.jpg')); ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset ('assets/tracki/img/favicons/sparkle_hrms.jpg')); ?>">
    <link rel="manifest" href="<?php echo e(asset ('assets/tracki/img/favicons/manifest.json')); ?>">
    <meta name="msapplication-TileImage" content="<?php echo e(asset ('assets/tracki/img/favicons/mstile-150x150.png')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\tracki\layout\dashboard.blade.php ENDPATH**/ ?>