...
<div class="card mb-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="employee_leave_table" data-classes="table <?php echo e(config('tracki.component_table_style')); ?>"
                data-toggle="table" data-loading-template="loadingTemplate"
                data-url="<?php echo e(route('tracki.employee.leave.list', $employeeid)); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\employee-profile-leave-card.blade.php ENDPATH**/ ?>