...
<!-- ===============================================-->
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('hr.admin.letter')); ?>">
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('hr.admin.layout.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\hr\admin\letter\create.blade.php ENDPATH**/ ?>