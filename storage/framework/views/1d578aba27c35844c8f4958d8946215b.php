<!-- <div class="card mb-4"> -->
    <!-- <div class="card-body"> -->
        ...
        <div class="table-responsive text-nowrap">
            ...
            <table
                ...
                data-search="true"
                data-url="<?php echo e(route('projects.admin.employee.project.list', $empId)); ?>"
    ...
    <!-- </div> -->
<!-- </div> --><?php /**PATH C:\xampp\htdocs\laravel\marketers\resources\views\components\admin-employee-projects-card.blade.php ENDPATH**/ ?>