                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center mb-3 mb-md-0 mb-xl-3">
                                                        <div class="avatar avatar-xl me-3"><img class="rounded-circle"
                                                                ...
                                                                alt="" /></div>
                                                        <div>
                            @if ($projectData->hasClient())

                                                            {{-- <h5>{{ $projectData->client?->pluck('first_name')->first() . ' ' . $projectData->client?->pluck('last_name')->first() }} --}}
                                                            {{-- </h5> --}}
                                                            @endif
...
<div class="tab-pane fade" id="tab-activity" role="tabpanel" aria-labelledby="activity-tab">
    ...
    <div class="mb-4 mt-4">
        <div class="d-flex flex-wrap gap-3">
            ...
            <div>
                <select class="form-select select-appearance" id="tasks_status_filter" aria-label="Default select example">
            ...
            <div class="ms-xxl-auto">
                ...
                <a href="#!" id="add_task" data-action="store" data-source="manage" data-type="add" data-table="task_table" data-id="0">
                                    ...
                                    <td class="customer align-middle white-space-nowrap ps-2"><a
                                            ...
                                            <div class="avatar avatar-m">
                                                <div class="avatar-name rounded-circle">
                                                    <span>{{ substr($item->first_name, 0, 1) }}</span>
                                                </div>
                                            </div>
                                            <p
