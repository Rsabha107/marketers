...
<div class="mb-5">
    ...
    <div class="border-bottom border-dashed mb-3">
        <div class="me-n3 mb-4">
            <div class="d-flex flex-between-center">
                <div class="d-flex mb-1"><span class="fa-solid fa-image me-2 text-body-tertiary fs-9"></span>
                    <p class="text-body-highlight mb-0 lh-1">
                        <a href="{{asset('/upload/event_files/')}}/{{$file->file_name}}" target="_blank">{{$file->original_file_name}}</a>
                    </p>
                </div>
            ...
            <a href="{{asset('/upload/event_files/')}}/{{$file->file_name}}" target="_blank"><img class="rounded-2 img-thumbnail" src="{{asset('/upload/event_files/')}}/{{$file->file_name}}" alt="" width="200" height="200"></a>
            @endif
        </div>
    </div>
    @endforeach
