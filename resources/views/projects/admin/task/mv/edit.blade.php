...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3 col-sm-6 col-md-12">
            <div class="form-floating">
                <input class="form-control" name="name" id="add_task_name" type="text"
                    placeholder="Project title" value="{{ $task->name }}" required />
                ...
                <div class="form-floating">
                    <select name="status_id" class="form-select" id="add_task_status">
                        ...
                        <option value="{{ $item->id }}"
                            {{ $task->status_id == $item->id ? 'selected' : null }}>
                            {{ $item->title }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="flatpickr-input-container">
                    <div class="form-floating">
                        <input 
                            ...
                            value="{{ $task->start_date ? \Carbon\Carbon::parse($task->start_date)->format('d/m/Y') : null }}"
                ...
                <div class="flatpickr-input-container">
                    <div class="form-floating">
                        <input 
                            ...
                            value="{{ $task->due_date ? \Carbon\Carbon::parse($task->due_date)->format('d/m/Y') : null }}"
                            name="due_date"
                            data-options='{"disableMobile":true,"dateFormat":"d/m/Y"}' />
            ...
            <div class="mb-3 col-sm-6 col-md-6">
                <div class="form-floating">
                    <input class="form-control" name="budget_allocation" id="add_task_budget" type="number" step="0.01"
                        placeholder="" value="{{ $task->budget_allocation }}"/>
            ...
            <div class="mb-3 col-sm-6 col-md-6">
                <div class="form-floating">
                    <input class="form-control" name="actual_budget_allocated" id="add_task_budget_utilization" type="number" step="0.01"
                        placeholder="" value="{{ $task->actual_budget_allocated }}"/>
        ...
        <div class="col-12 gy-3 mb-3">
            <div class="form-floating">
                <textarea class="form-control" name="description" id="add_task_description" placeholder="" style="height: 100px" required>{{ $task->description }}</textarea>
                <div class="invalid-feedback">
