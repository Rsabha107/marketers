                    ...
                    <div class="nav-item-wrapper">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('procurement/admin/items') ? 'active' : '' }}" href="{{ route('procurement.admin.items') }}">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('procurement/admin/items') ? 'active' : '' }}" href="{{ route('procurement.admin.vendor') }}">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('procurement/admin/purchase') ? 'active' : '' }}" href="{{ route('procurement.admin.purchase') }}">
                                        <div class="d-flex align-items-center">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link"
                                        href="{{ route('general.settings.company') }}">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link"
                                        href="{{ route('general.settings.address') }}">
                                        <div class="d-flex align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link"
                                        href="{{ route('general.settings.currency') }}">
                                        <div class="d-flex align-items-center">
