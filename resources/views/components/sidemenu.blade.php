    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    @if (Auth::user()->can('procurement.menu'))
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1 {{ Request::is('procurement/admin*') ? '' : 'collapsed' }}"
                                href="#nv-procurement-managementz" role="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="nav-link-icon"><i
                                            class="fa-solid fa-clipboard text-success"></i></span><span
                                        class="nav-link-text">Procurement</span>
                                </div>
                            </a>
                            <div class="parent-wrapper label-1">
                                <ul class="nav collapse parent {{ Request::is('procurement/admin*') ? 'show' : '' }}"
                                    data-bs-parent="#navbarVerticalCollapse" id="nv-procurement-managementz">
                                    <li class="collapsed-nav-item-title d-none">
                                        procurement management
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ Request::is('procurement/admin/items') ? 'active' : '' }}"
                                            href="{{ route('procurement.admin.items') }}">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ Request::is('procurement/admin/items') ? 'active' : '' }}"
                                            href="{{ route('procurement.admin.vendor') }}">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ Request::is('procurement/admin/purchase') ? 'active' : '' }}"
                                            href="{{ route('procurement.admin.purchase') }}">
                                            <div class="d-flex align-items-center">
                                    ...
                                    @if (Auth::user()->can('procurement.setting.menu'))
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-indicator {{ Request::is('projects/admin/setting*') ? '' : 'collapsed' }}"
                                                href="#nv-settings" data-bs-toggle="collapse"
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent {{ Request::is('projects/admin/setting*') ? 'show' : '' }}"
                                                    data-bs-parent="#settings" id="nv-settings">
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('projects/admin/setting/category') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('projects/admin/setting/audience') ? 'active' : '' }}"
                                            ...
                                            <!-- more inner pages-->
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('projects/admin/setting/tag') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('projects/admin/setting/location') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('projects/admin/setting/venue') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/departments') || Request::is('projects/admin/setting/departments') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/funcareas') || Request::is('projects/admin/setting/funcareas') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('projects/admin/setting/projecttype') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    ...
                    @if (Auth::user()->can('project.menu'))
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1 {{ Request::is('projects/admin/project*') || Request::is('projects/admin/task*') || Request::is('projects/admin/setting*') ? '' : 'collapsed' }}"
                                href="#nv-project-managementz" role="button" data-bs-toggle="collapse"
                            ...
                            <div class="parent-wrapper label-1">
                                <ul class="nav collapse parent {{ Request::is('projects/admin/project*') || Request::is('projects/admin/task*') || Request::is('projects/admin/setting*') ? 'show' : '' }}"
                                    data-bs-parent="#navbarVerticalCollapse" id="nv-project-managementz">
                                    <li class="collapsed-nav-item-title d-none">
                                        Project management
                                    </li>
                                    {{-- <li class="nav-item">
                                        <a class="nav-link dropdown-indicator {{ Request::is('projects/admin/project*') || Request::is('projects/admin/task*') ? '' : 'collapsed' }}"
                                            href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true"
                                        ...
                                        <!-- more inner pages-->
                                        <div class="parent-wrapper">
                                            <ul class="nav collapse parent {{ Request::is('projects/admin/project*') || Request::is('projects/admin/task*') ? 'show' : '' }}"
                                                data-bs-parent="#project-managementz" id="nv-admin">
                                                <li class="nav-item">
                                                    <a class="nav-link {{ Request::is('projects/admin/project*') ? 'active' : '' }}"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ Request::is('projects/admin/task') ? 'active' : '' }}"
                                            href="{{ route('projects.admin.task') }}">
                                            <div class="d-flex align-items-center">
        ...
        <li class="nav-item">
            ...
            <!-- more inner pages-->
                    ...
                    @if (Auth::user()->can('hrms.menu'))
                        <div class="nav-item-wrapper">
                            <a class="nav-link dropdown-indicator label-1 {{ Request::is('hr/admin/*') || Request::is('tracki/payroll/*') ? '' : 'collapsed' }}"
                                href="#nv-hrms" role="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="nav-link-icon"><i class="fa fa-users text-primary"
                                            aria-hidden="true"></i></span><span class="nav-link-text">HRMS
                                        (Admin)</span>
                                </div>
                            </a>
                            <div class="parent-wrapper label-1">
                                <ul class="nav collapse parent {{ Request::is('hr/admin*') || Request::is('tracki/setting/*') || Request::is('tracki/payroll*') ? 'show' : '' }}"
                                    data-bs-parent="#navbarVerticalCollapse" id="nv-hrms">
                                    <li class="collapsed-nav-item-title d-none">
                                        HRMS
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ Request::is('hr/admin/employee') ? 'active' : '' }}"
                                    ...
                                    @if (Auth::user()->hasrole('Manager'))
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-indicator {{ Request::is('tracki/employee/managers/*') ? '' : 'collapsed' }}"
                                                href="#nv-manager" data-bs-toggle="collapse"
                                            ...
                                            <!-- more inner pages-->
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent {{ Request::is('tracki/employee/managers*') ? 'show' : '' }}"
                                                    data-bs-parent="#manager" id="nv-manager">
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('tracki/employee/managers') ? 'active' : '' }}"
                                                    ...
                                                    @can('leave.show')
                                                        <li class="nav-item">
                                                            <a class="nav-link {{ Request::is('tracki/employee/managers/leave') ? 'active' : '' }}"
                                                    ...
                                                    @endcan
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('tracki/employee/managers/timesheet') ? 'active' : '' }}"
                                    ...
                                    @if (Auth::user()->hasrole('Payroll'))
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-indicator {{ Request::is('tracki/payroll/*') ? '' : 'collapsed' }}"
                                                href="#nv-payroll" data-bs-toggle="collapse"
                                                aria-expanded="{{ Request::is('tracki/employee/*') ? 'true' : 'false' }}"
                                            ...
                                            <!-- more inner pages-->
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent {{ Request::is('tracki/payroll*') ? 'show' : '' }}"
                                                    data-bs-parent="#payroll" id="nv-payroll">
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('tracki/payroll/timesheet') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('tracki/payroll/timesheet/missing') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('tracki/payroll/bank') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('tracki/payroll/payment') ? 'active' : '' }}"
                                    ...
                                    @hasanyrole('SuperAdmin|HRMSADMIN')
                                        @can('leave.show')
                                            <li class="nav-item">
                                                <a class="nav-link {{ Request::is('hr/admin/leave') ? 'active' : '' }} label-1"
                                        ...
                                        @endcan
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/admin/address') ? 'active' : '' }} label-1"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/admin/bank') ? 'active' : '' }} label-1"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/admin/timesheet') ? 'active' : '' }} label-1"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/admin/salary') ? 'active' : '' }} label-1"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/admin/emergency') ? 'active' : '' }} label-1"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/amdin/files') ? 'active' : '' }}"
                                    ...
                                    @hasanyrole('SuperAdmin|HRMSADMIN')
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-indicator {{ Request::is('tracki/employee/letter*') ? '' : 'collapsed' }}"
                                                href="#nv-letter" data-bs-toggle="collapse"
                                            ...
                                            <!-- more inner pages-->
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent {{ Request::is('hr/admin/letter/*') ? 'show' : '' }}"
                                                    data-bs-parent="#letter" id="nv-letter">
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/letter/generate') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/letter') ? 'active' : '' }}"
                                    ...
                                    @if (Auth::user()->can('audit.show'))
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/admin/setting/audit') ? 'active' : '' }} label-1"
                                    ...
                                    @if (Auth::user()->can('setup.menu'))
                                        <li class="nav-item">
                                            <a class="nav-link dropdown-indicator {{ Request::is('tracki/employee/*') ? '' : 'collapsed' }}"
                                                href="#nv-settings" data-bs-toggle="collapse"
                                                aria-expanded="{{ Request::is('tracki/employee/*') ? 'true' : 'false' }}"
                                                aria-controls="nv-settings">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <!-- more inner pages-->
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent {{ Request::is('hr/admin/setting/*') ? 'show' : '' }}"
                                                    data-bs-parent="#settings" id="nv-settings">
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/designations') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/joblevel') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/sponsorship') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/contracttype') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/addresstype') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/funcareas') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/gender') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/prefix') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/marital') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/countries') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/nationalities') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/departments') ? 'active' : '' }}"
                            ...
                            <div class="d-flex align-items-center">
                                <span class="nav-link-text">Priority</span>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/entities') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/directorates') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/relationships') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/leavetypes') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/element/classifications') ? 'active' : '' }}"
                                                            href="{{ route('hr.admin.setting.element.classifications') }}">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Element
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/element') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ Request::is('hr/admin/setting/elementset') ? 'active' : '' }}"
                ...
                <!-- more inner pages-->
                                                    ...
                                                    @hasanyrole('Payroll|SuperAdmin')
                                                        <li class="nav-item">
                                                            <a class="nav-link {{ Request::is('hr/admin/setting/paycycle') ? 'active' : '' }}"
                                        ...
                                        @endif
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('hr/admin/setting/invoice/notes') ? 'active' : '' }}"
                    ...
                    <div class="nav-item-wrapper">
                        <a class="nav-link dropdown-indicator label-1 {{ Request::is('sec/permissions/*') || Request::is('sec/roles/*') || Request::is('sec/groups/*')
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-icon"><i
                                        class="fa-solid fa-user-shield text-warning"></i></span><span
