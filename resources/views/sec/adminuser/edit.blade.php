...
@section('main')
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            <form method="POST" action="{{ route('sec.adminuser.update') }}"
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" id="userUser" type="radio" name="usertype" value="user" {{($user->usertype == 'user')? "checked":""}} required />
                    <label class="form-check-label" for="inlineRadio2">User</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" id="adminUser" type="radio" name="usertype" value="admin" {{($user->usertype == 'admin')? "checked":""}} required />
