...
@if (Request::is('hr/admin/employee'))
<div class="offcanvas offcanvas-end w-70" data-bs-backdrop="static" id="add_employee_modal" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body bg-body-highlight">
        <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_form" novalidate="" action="{{ route ('hr.admin.employee.store') }}" method="POST">
            @csrf
...
<div class="offcanvas offcanvas-end w-70" data-bs-backdrop="static" id="edit_employee_modal" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body bg-body-highlight">
        <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_form" novalidate="" action="{{ route ('hr.admin.employee.update') }}" method="POST">
            @csrf
...
<div class="offcanvas offcanvas-end w-70" data-bs-backdrop="static" id="duplicate_employee_modal" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body bg-body-highlight">
        <form class="row g-3  px-3 needs-validation form-submit-event" id="duplicate_employee_form" novalidate="" action="{{ route ('hr.admin.employee.store') }}" method="POST">
            @csrf
...
<div class="modal fade" id="add_employee_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-top modal-dialog-scrollable">
        <div class="modal-content ">
            ...
            ?>
            <div class="modal-body">
                <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_formxx" novalidate="" action="{{ route ('hr.admin.employee.store') }}" method="POST">
                    @csrf
...
@if (Request::is('hr/admin/timesheet/entries*'))
<div class="modal fade" id="edit_employee_timesheet_entry_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_entry_form" novalidate="" action="{{ route ('hr.admin.timesheet.entries.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/timesheet') || Request::is('tracki/employee/profile*'))
<div class="modal fade" id="add_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_form" novalidate="" action="{{ route ('hr.admin.timesheet.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="add_employee_profile_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_profile_form" novalidate="" action="{{ route ('hr.admin.timesheet.store') }}" method="POST">
                @csrf
                <input type="hidden" id="add_employee_timesheet_table_h" name="table" value="employee_timesheet_table">
...
<div class="modal fade" id="edit_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_form" novalidate="" action="{{ route ('hr.admin.timesheet.update') }}" method="POST">
                @csrf
...
<div class="modal fade" id="timesheetStatusModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" novalidate="" action="{{route('hr.admin.timesheet.status.update')}}" method="POST" id="change_timesheet_status">
...
@if (Request::is('hr/admin/salary') || Request::is('tracki/employee/profile*'))
<div class="modal fade" id="add_employee_salary_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_salary_form" novalidate="" action="{{ route ('hr.admin.salary.store') }}" method="POST">
                @csrf
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-select" name="payroll_cycle_id" required>
                                    <option value="" selected>Select...</option>
                                    @foreach ($payroll_cycles as $key => $item )
                                    <option value="{{ $item->id  }}">
                                        {{ $item->title }}
                                    </option>
                                    @endforeach
...
<div class="modal fade" id="edit_employee_salary_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_salary_form" novalidate="" action="{{ route ('hr.admin.salary.update') }}" method="POST">
                @csrf
...
<div class="modal fade" id="add_employee_leave_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_leave_form" novalidate="" action="{{ route ('tracki.employee.leave.store') }}" method="POST" enctype='multipart/form-data'>
                @csrf
...
@if (Request::is('hr/admin/bank') || Request::is('tracki/employee/profile*'))
<div class="modal fade" id="add_employee_bank_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_bank_form" novalidate="" action="{{ route ('hr.admin.bank.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="add_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_emergency_form" novalidate="" action="{{ route ('hr.admin.emergency.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_emergency_form" novalidate="" action="{{ route ('hr.admin.emergency.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/address') || Request::is('tracki/employee/profile*'))
<div class="modal fade" id="add_employee_address_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_address_form" novalidate="" action="{{ route ('hr.admin.address.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_employee_address_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content bg-body-highlight">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_address_form" novalidate="" action="{{ route ('hr.admin.address.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/addresstype*'))
<div class="modal fade" id="create_address_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_address_type_form" novalidate="" action="{{ route('hr.admin.setting.addresstype.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_address_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_address_type_form" novalidate="" action="{{ route('hr.admin.setting.addresstype.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/prefix*'))
<div class="modal fade" id="create_prefix_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_prefix_form" novalidate="" action="{{ route('hr.admin.setting.prefix.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_prefix_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_prefix_form" novalidate="" action="{{ route('hr.admin.setting.prefix.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/gender*'))
<div class="modal fade" id="create_gender_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_gender_form" novalidate="" action="{{ route('hr.admin.setting.gender.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_gender_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_gender_form" novalidate="" action="{{ route('hr.admin.setting.gender.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/invoice/notes*'))
<div class="modal fade" id="create_invoice_notes_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_invoice_notes_form" novalidate="" action="{{ route('hr.admin.setting.invoice.notes.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_invoice_notes_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_invoice_notes_form" novalidate="" action="{{ route('hr.admin.setting.invoice.notes.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/marital*'))
<div class="modal fade" id="create_marital_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_marital_form" novalidate="" action="{{ route('hr.admin.setting.marital.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_marital_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_marital_form" novalidate="" action="{{ route('hr.admin.setting.marital.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/entities*'))
<div class="modal fade" id="create_entity_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_entity_form" novalidate="" action="{{ route('hr.admin.setting.entities.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_entity_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_entity_form" novalidate="" action="{{ route('hr.admin.setting.entities.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/element/classifications*'))
<div class="modal fade" id="create_element_classificaiton_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_element_classification_form" novalidate="" action="{{ route('hr.admin.setting.element.classifications.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_element_classificaiton_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_element_classificaiton_form" novalidate="" action="{{ route('hr.admin.setting.element.classifications.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/element'))
<div class="modal fade" id="create_element_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_element_form" novalidate="" action="{{ route('hr.admin.setting.element.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_element_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_element_form" novalidate="" action="{{ route('hr.admin.setting.element.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/elementset'))
<div class="modal fade" id="create_elementset_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_elementset_form" novalidate="" action="{{ route('hr.admin.setting.elementset.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_elementset_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_elementset_form" novalidate="" action="{{ route('hr.admin.setting.elementset.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/directorates*'))
<div class="modal fade" id="create_directorate_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_directorate_form" novalidate="" action="{{ route('hr.admin.setting.directorates.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_directorate_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_directorate_form" novalidate="" action="{{ route('hr.admin.setting.directorates.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/relationships*'))
<div class="modal fade" id="create_relationship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_relationship_form" novalidate="" action="{{ route('hr.admin.setting.relationships.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_relationship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_relationship_form" novalidate="" action="{{ route('hr.admin.setting.relationships.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/leavetypes*'))
<div class="modal fade" id="create_leave_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_leave_type_form" novalidate="" action="{{ route('hr.admin.setting.leavetypes.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_leave_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_leave_type_form" novalidate="" action="{{ route('hr.admin.setting.leavetypes.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/countries*'))
<div class="modal fade" id="create_country_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_country_form" novalidate="" action="{{ route('hr.admin.setting.countries.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_country_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_country_form" novalidate="" action="{{ route('hr.admin.setting.countries.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/nationalities*'))
<div class="modal fade" id="create_nationality_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_nationality_form" novalidate="" action="{{ route('hr.admin.setting.nationalities.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_nationality_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_nationality_form" novalidate="" action="{{ route('hr.admin.setting.nationalities.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/paycycle*'))
<div class="modal fade" id="create_pay_cycle_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_pay_cycle_form" novalidate="" action="{{ route('hr.admin.setting.paycycle.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_pay_cycle_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_pay_cycle_form" novalidate="" action="{{ route('hr.admin.setting.paycycle.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/joblevel*'))
<div class="modal fade" id="create_job_level_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_job_level_form" novalidate="" action="{{ route('hr.admin.setting.joblevel.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_job_level_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_job_level_form" novalidate="" action="{{ route('hr.admin.setting.joblevel.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/sponsorship*'))
<div class="modal fade" id="create_sponsorship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_sponsorship_form" novalidate="" action="{{ route('hr.admin.setting.sponsorship.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_sponsorship_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_sponsorship_form" novalidate="" action="{{ route('hr.admin.setting.sponsorship.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/contracttype*'))
<div class="modal fade" id="create_contract_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_contract_type_form" novalidate="" action="{{ route('hr.admin.setting.contracttype.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_contract_type_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_contract_type_form" novalidate="" action="{{ route('hr.admin.setting.contracttype.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/designations'))
<!-- designations modal -->
<div class="modal fade" id="create_designations_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event" action="{{route('hr.admin.setting.designations.store')}}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_designations_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="edit_form_submit_event" action="{{route('hr.admin.setting.designations.update')}}" method="POST">
                @csrf
...
@if (Request::is('hr/admin/setting/departments'))
<!-- departments modal -->
...
@if (Request::is('hr/admin/setting/funcareas'))
<!-- venues modal -->
