                        ...
                        <div>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="deals-items-head d-flex align-items-center mb-2"><a
                                            class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7"
                                            href="#">Contacts <span>({{ $employee_data->emergency_contacts?->count() }})</span></a>
                                        <p class="deals-category fs-10 mb-0 mt-1 d-none"><span
                                                class="me-1 text-body-quaternary" data-feather="grid"
                                                style="stroke-width:2; height: 12px; width: 12px"></span>Detail
                                        </p>
                                                ...
                                                <table class="table table-sm fs-9 mb-0">
                                                    ...
                                                    <tbody class="list" id="customer-order-table-body">
                                                        ...
                                                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                            <td class="name align-middle white-space-nowrap ps-0"><a class="fw-semibold" href="#!">{{ $item->first_name }} {{ $item->last_name }}</a></td>
                                                            <td class="relationship align-middle text-end fw-semibold pe-7 text-body-highlight">{{ $item->relationships->title }}</td>
                                                            <td class="contact_number align-middle text-end fw-semibold pe-7 text-body-highlight">{{ $item->contact_number }}</td>
                        ...
                        <div>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="deals-items-head d-flex align-items-center mb-2"><a
                                            class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7"
                                            href="#">Timesheets <span>({{ $employee_data->timesheets?->count() }})</span></a>
                                        <p class="deals-category fs-10 mb-0 mt-1 d-none"><span
                                                class="me-1 text-body-quaternary" data-feather="grid"
                                                style="stroke-width:2; height: 12px; width: 12px"></span>Detail
                                        </p>
                                            ...
                                            <div class="table-responsive scrollbar">
                                                <table class="table table-sm fs-9 mb-0">
                                                    ...
                                                    <tbody class="list" id="customer-order-table-body">
                                                        ...
                                                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                            <td class="month align-middle white-space-nowrap ps-0"><a class="fw-semibold" href="#!">{{ $item->timesheet_period }}</a></td>
                                                            <td class="payment align-middle text-end fw-semibold pe-7 text-body-highlight">{{ $item->total_payments }}</td>
                                                            <td class="timesheet_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span class="badge badge-phoenix fs-10 badge-phoenix-{{ $item->leave_statuses?->color }}"><span class="badge-label">{{ $item->leave_statuses?->title }}</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
