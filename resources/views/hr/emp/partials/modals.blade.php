...
<div class="modal fade" id="add_employee_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-top modal-dialog-scrollable">
        <div class="modal-content ">
            ...
            ?>
            <div class="modal-body">
                <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_formxx" novalidate="" action="{{ route ('tracki.employee.store') }}" method="POST">
                    @csrf
...
@if (Request::is('hr/manager/timesheet*')||Request::is('hr/payroll/timesheet*'))
...
@if (Request::is('hr/emp/timesheet/entries*'))
<div class="modal fade" id="edit_employee_timesheet_entry_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_entry_form" novalidate="" action="{{ route ('hr.emp.timesheet.entries.update') }}" method="POST">
                @csrf
...
@if (Request::is('hr/emp/timesheet') || Request::is('tracki/employee/profile*'))
<div class="modal fade" id="add_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_form" novalidate="" action="{{ route ('hr.emp.timesheet.store') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="hidden" id="add_timesheet_employee_profile_id" name="employee_id" value="{{$employee_id}}">
...
<div class="modal fade" id="add_employee_profile_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_timesheet_profile_form" novalidate="" action="{{ route ('hr.emp.timesheet.store') }}" method="POST">
                @csrf
                <input type="hidden" id="add_employee_timesheet_table_h" name="table" value="employee_timesheet_table">
...
<div class="modal fade" id="edit_employee_timesheet_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_timesheet_form" novalidate="" action="{{ route ('hr.emp.timesheet.update') }}" method="POST">
                @csrf
...
<div class="modal fade" id="timesheetStatusModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" novalidate="" action="{{route('hr.emp.timesheet.status.update')}}" method="POST" id="change_timesheet_status">
...
<div class="modal fade" id="add_employee_salary_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_salary_form" novalidate="" action="{{ route ('tracki.employee.salary.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="add_employee_bank_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_bank_form" novalidate="" action="{{ route ('tracki.employee.bank.store') }}" method="POST">
                @csrf
...
@if (Request::is('hr/emp/emergency') || Request::is('tracki/employee/profile*'))
<div class="modal fade" id="add_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_emergency_form" novalidate="" action="{{ route ('hr.emp.emergency.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_employee_emergency_contact_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content ">
            ...
            //
            ?>
            <form class="row g-3  px-3 needs-validation form-submit-event" id="edit_employee_emergency_form" novalidate="" action="{{ route ('hr.emp.emergency.update') }}" method="POST">
                @csrf
...
@if (Request::is('tracki/setting/prefix*'))
<div class="modal fade" id="create_prefix_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_prefix_form" novalidate="" action="{{ route('tracki.setting.prefix.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_prefix_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_prefix_form" novalidate="" action="{{ route('tracki.setting.prefix.update') }}" method="POST">
                @csrf
...
@if (Request::is('tracki/setting/elementset'))
<div class="modal fade" id="create_elementset_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_elementset_form" novalidate="" action="{{ route('tracki.setting.elementset.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_elementset_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_elementset_form" novalidate="" action="{{ route('tracki.setting.elementset.update') }}" method="POST">
                @csrf
...
@if (Request::is('tracki/setting/pay_cycle*'))
<div class="modal fade" id="create_pay_cycle_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_pay_cycle_form" novalidate="" action="{{ route('tracki.setting.pay_cycle.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_pay_cycle_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_pay_cycle_form" novalidate="" action="{{ route('tracki.setting.pay_cycle.update') }}" method="POST">
                @csrf
