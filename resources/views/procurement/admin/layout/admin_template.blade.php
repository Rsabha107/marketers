...
<body class="nav-slim">
    ...
    <main class="main" id="top">
        ...
        {{-- @include('procurement.admin.body.sidebar') --}}
        <x-sidemenu />

        @include('procurement.admin.body.header')

        {{-- // start of content --}}
        <div class="content">
            @yield('main')
            @include('procurement.admin.partials.modals')
            @if ((Request::is('procurement/admin/setting/*')))
                @include('procurement.admin.partials.setup-modals')
            @endif
            @include('procurement.admin.partials.labels')
            @include('procurement.admin.body.footer')
        </div>
        {{-- // end of content --}}
