...
<input type="hidden" id="edit_vendor_id" name="id" value="{{$vendor->id}}">
<div>
        ...
        <div class="card-body">
            ...
            <div class="col-12 gy-3 mb-3">
                <div class="form-floating">
                    <textarea 
                        class="form-control  
                        @error('shipping_address') is-invalid @enderror" 
                        name="billing_address" 
                        id="floatingProjectOverview" 
                        placeholder="eg:"
                        style="height: 100px">{{ $vendor->billing_address }}</textarea>
                    <div class="invalid-feedback">
            ...
            <div class="col-12 gy-3 mb-3">
                <div class="form-floating">
                    <textarea 
                        ...
                        id="floatingProjectOverview" 
                        placeholder="eg:"
                        style="height: 100px">{{ $vendor->shipping_address }}</textarea>
                    <div class="invalid-feedback">
