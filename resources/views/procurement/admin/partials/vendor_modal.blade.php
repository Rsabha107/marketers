        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="row g-3 needs-validation form-submit-event" id="edit_vendor_form" novalidate=""
                    action="{{ route('procurement.vendor.update') }}" method="POST">
                    @csrf
...
<div class="offcanvas offcanvas-end offcanvas-global-modal in" id="offcanvas-add-vendor-modal" tabindex="-1"
    ...
    <x-procurement.vendor.admin-drawer-vendor id="" 
                            formAction="{{ route('procurement.vendor.store') }}" 
                            currency="anything"
                            formId="add_vendor_form"
    >

    </x-procurement.vendor.admin-drawer-vendor>
