        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="row g-3 needs-validation form-submit-event" id="edit_item_master" novalidate=""
                    action="{{ route('procurement.items.update') }}" method="POST">
                    @csrf
...
<div class="offcanvas offcanvas-end offcanvas-global-modal in" id="offcanvas-add-item-master-modal" tabindex="-1"
    ...
    <x-procurement.items.admin-item-drawer id=""
        formAction="{{ route('procurement.items.store') }}"
        :unittypes="$unit_types"
        :categories="$categories"
        :subcategories="$sub_categories"
        formId="add_item_master">

    </x-procurement.items.admin-item-drawer>
