        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="row g-3 needs-validation form-submit-event" id="edit_purchase_form" novalidate=""
                    action="{{ route('procurement.purchase.update') }}" method="POST">
                    @csrf
...
<div class="offcanvas offcanvas-end offcanvas-global-modal in" id="offcanvas-add-purchase-modal" tabindex="-1"
    ...
    <x-procurement.purchase.admin-purchase-drawer id="" 
                            formAction="{{ route('procurement.purchase.store') }}" 
                            currency="anything"
                            formId="add_purchase_form"
                            :vendors="$vendors"
                            :projects="$projects"
                            :items="$items"
                            :currency="$currency"
    ...
    </x-procurement.purchase.admin-purchase-drawer>
