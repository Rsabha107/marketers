...
<!-- ===============================================-->
        ...
        <div class="mb-4 mt-4">
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="ms-xxl-auto">
                    ...
                    <a href="{{ route('tracki.employee.letter.create') }}" target="_blank">
    ...
    <div class="offcanvas offcanvas-end w-70" data-bs-backdrop="static" id="edit_template_modal" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
        ...
        <div class="offcanvas-body">
            <form class="row g-3  px-3 needs-validation form-submit-event" id="add_employee_letter_form" novalidate="" action="{{ route ('tracki.employee.letter.store') }}" method="POST">
                @csrf
