...
@if (Request::is('tracki/setting/element_set'))
<div class="modal fade" id="create_element_set_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            ...
            <form class="needs-validation px-3 form-submit-event" id="create_element_set_form" novalidate="" action="{{ route('tracki.setting.element_set.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_element_set_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-event" id="edit_element_set_form" novalidate="" action="{{ route('tracki.setting.element_set.update') }}" method="POST">
                @csrf
